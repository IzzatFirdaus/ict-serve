...
An integrated ICT Loan & Helpdesk system for the Ministry of Tourism, Arts, and Culture (MOTAC), Malaysia. This project merges two legacy systems into a unified, modern application built with Laravel 12, following best Git practices for a clean, collaborative, citizen-centric workflow.

| [![Jata Negara](https://d2391uizq0pg2.cloudfront.net/common/jata-negara.png)](https://www.digital.gov.my/) | [![Filament Logo](https://filamentphp.com/images/logo.svg)](https://filamentphp.com/) |
| :--------------------------------------------------------------------------------------------------------: | :-----------------------------------------------------------------------------------: |
|                             [Ministry of Digital](https://www.digital.gov.my/)                             |                         [Filament](https://filamentphp.com/)                          |
...
- **Reusable Components**: Buttons, inputs, selects, checkboxes, and more.
- **Color Tokens**: Full semantic color system (primary, danger, success, warning, neutral).
...
All feature tests for dashboard, forms, navigation, and accessibility must pass.
...
## Official Resources & Implementation Notes

Authoritative links and short implementation notes for developers:

- **Design docs**: <https://design.digital.gov.my/en/docs/design>
- **Developer docs (Component Library)**: <https://design.digital.gov.my/en/docs/develop>
- **Colour reference**: <https://design.digital.gov.my/en/docs/design/color>
- **12-8-4 Grid**: <https://design.digital.gov.my/en/docs/design/12-8-4-grid>
- **Typography guidance**: <https://design.digital.gov.my/en/docs/design/typography>
- **Components index / Storybook**: <https://myds-storybook.vercel.app/>
- **Figma design canvas**: <https://www.figma.com/file/svmWSPZarzWrJ116CQ8zpV/MYDS-(Beta)>
- **Contact / feedback**: `design@tech.gov.my` (mailto:design@tech.gov.my)
- **Ministry**: <https://www.digital.gov.my/>
...
- **Prefer official components**: When building React/JS frontends, use official or local component wrappers where available; follow the component anatomy in the docs (e.g., Dialogs must include header/content/footer parts).
...
- **Contribution & governance**: Follow contributing guidelines on the GitHub repo when proposing changes to tokens or components.

If you want, I can:

- Add a small `tokens.css` file that maps a minimal set of tokens used by this project to CSS variables, or
- Scaffold a small `components/tokens` wrapper folder with a button and input components that consume tokens and include accessibility defaults.
...
You are an expert assistant for Laravel, PHP, Git, and GitHub. Your purpose is to guide contributors to write clean, maintainable, and collaborative code that aligns with accessibility and quality-first principles.

<<<<<<< HEAD
### 1. Overarching Principle — Citizen‑Centric
=======
## Copilot Spaces Instructions
...
- Use tokens & components: Prefer semantic tokens (e.g., `bg-primary-600`, `txt-danger`) and component primitives for buttons, forms, tables, dialogs.
...
- Always frame technical advice by accessibility and quality-first design principles: simple, inclusive, and consistent. When suggesting third-party tools, verify compatibility with Laravel 12 and avoid introducing breaking changes without migration guidance.
...
<<<<<<< HEAD
Below are the iterative iServe (ICT Serve) planning documents capturing the evolution of the unified ICT Loan + Helpdesk strategy. Each version builds on the previous with refinements in citizen-centric design, accessibility, dynamic configurability, and Livewire implementation detail.
=======
...
<<<<<<< HEAD
Robust, citizen-centric plan to combine ICT Loan and Helpdesk modules into ICT Serve (iServe).

#### 1. Planning and Principles

Core Principle: Citizen-Centric – All features, UI, and workflows designed for MOTAC staff needs.

Design System:

- Compliance: Use components (forms, buttons, navigation, tables). Accessibility, contrast, responsive 12-8-4 grid.
- Alignment: Minimalism, clarity, error prevention, documented standards.
...
Forms: Components, validation, confirmations.
...
Laravel backend + REST API; Auth via Breeze/Fortify or SSO.
...
Refined plan shifting frontend to Laravel + Livewire + Blade for cohesive stack.
...
Adds explicit grounding in accessibility references; more granular compliance emphasis.
...
| Accessibility     | Baseline        | Structured            | Deep WCAG           | Maintained           | Reinforced patterns   |
...
4. Create Blade component library for wrappers (button, panel, callout, select, table).
