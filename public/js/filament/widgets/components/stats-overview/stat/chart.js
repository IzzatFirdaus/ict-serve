    ...
    ((x = t[S % a]),
      !x.skip &&
        ...
        b !== v &&
          ...
          m !== null &&
            w() &&
            (g.push(Zs({ start: m, end: S, loop: u, count: a, style: f })),
            (m = null)),
          (P = S),
          (v = b))));
  return (
    m !== null && g.push(Zs({ start: m, end: d, loop: u, count: a, style: f })),
    g
  );
}
function cs(i, t) {
  ...
  it = class {
    ...
    _update(t) {
      ...
      (this.update(t || 'default'),
        (e._clip = Mr(
          D(this.options.clip, vr(e.xScale, e.yScale, this.getMaxOverflow()))
        )));
    }
    update(t) {}
    draw() {
...
var re = class extends it {
  ...
  _getAxis() {
    ...
    for (let s of this.chart.data.datasets)
      t[D(this.chart.options.indexAxis === 'x' ? s.xAxisID : s.yAxisID, e)] =
        !0;
    return Object.keys(t);
  }
...
function ul(i) {
  return !hi() || (typeof OffscreenCanvas < 'u' && i instanceof OffscreenCanvas)
    ? Ss
    : Ps;
}
var st = class {
...
function Sl(i, t, e, s) {
  ...
  if (i.isHorizontal()) {
    if (((f = K(s, o, r)), T(e))) {
      ...
      e === 'center' ? (g = (c.bottom + c.top) / 2 + p - t) : (g = Yn(i, e, t));
    u = r - o;
  } else {
    if (T(e)) {
      let b = Object.keys(e)[0],
      ...
      e === 'center' ? (f = (c.left + c.right) / 2 - m + t) : (f = Yn(i, e, t));
      ...
      for (d = 0; d < e; d += l) {
        if (
          ...
          for (u = 0, f = g.length; u < f; ++u)
            ((_ = g[u]),
              !A(_) && !z(_) && ((v = Me(n, b.data, b.gc, v, _)), (y += x)));
...
function Uo(i, t) {
  ...
  return (
    ...
    e.length
      ? new pt({ points: e, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null
  );
}
function co(i) {
        ...
        (l.setWidth(this.width),
          v
            ...
            : w > 0 &&
              ...
              f.line++,
              (L = f.y =
                K(o, this.top + y + h, this.bottom - e[f.line].height))));
        let U = l.x(C);
        if (
          (b(U, L, k),
    ...
    _getLegendItemAt(t, e) {
      ...
      if (ut(t, this.left, this.right) && ut(e, this.top, this.bottom)) {
        for (o = this.legendHitBoxes, s = 0; s < o.length; ++s)
          if (
            ((n = o[s]),
            ut(t, n.left, n.left + n.width) && ut(e, n.top, n.top + n.height))
          )
...
var Ve = class extends st {
  ...
  getContext() {
    return (
      this.$context ||
      (this.$context = oh(this.chart.getContext(), this, this._tooltipItems))
    );
  }
  getTitle(t, e) {
    let { callbacks: s } = e,
...
var Ie = class extends Ut {
  ...
  parse(t, e) {
    ...
    return (
      (e =
        isFinite(e) && s[e] === t ? e : ch(s, t, D(e, t), this._addedLabels)),
      hh(e, s.length - 1)
    );
  }
  determineDataLimits() {
...
function kh(i, t, e) {
  ...
  if (!A(r)) {
    ...
    Object.values(l).some((g) => g !== 0)
      ? (i.beginPath(), ne(i, { x: h, y: d, w: u, h: f, radius: l }), i.fill())
      : i.fillRect(h, d, u, f);
  }
}
function wh(i, t) {
...
var Yt = class extends Ut {
  ...
  buildTicks() {
    ...
    return (
      ...
      (this._majorUnit =
        !s.major.enabled || this._unit === 'year' ? void 0 : Oh(this._unit)),
      this.initOffsets(n),
      t.reverse && r.reverse(),
