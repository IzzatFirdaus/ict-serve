...
var sn = class {
    ...
    finish(e) {
      ...
      return (
        !e && this.match && (n = n.append(this.match.fillBefore(x.empty, !0))),
      ...
      for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (
            n == 1 &&
            (s
              ? c.matchType(s.type) || (d = c.fillBefore(x.from(s), !1))
...
function Ba(t, e, n) {
  ...
  return (
    ...
    e > 0 &&
      ...
      n <= 0 &&
        (r = r.append(
          t.type.contentMatch.matchFragment(r).fillBefore(x.empty, !0)
        ))),
    t.copy(r)
  );
}
...
var O = class t extends D {
  ...
  static between(e, n, r) {
    ...
    if (((!r || o) && (r = o >= 0 ? 1 : -1), !n.parent.inlineContent)) {
      let i = D.findFrom(n, r, !0) || D.findFrom(n, -r, !0);
      if (i) n = i.$head;
    ...
    return (
      e.parent.inlineContent ||
        (o == 0
          ? (e = n)
          : ((e = (D.findFrom(e, -r, !0) || D.findFrom(e, r, !0)).$anchor),
            e.pos < n.pos != o < 0 && (e = n))),
      new t(e, n)
    );
  }
    ...
    insertText(e, n, r) {
          ...
          : this.deleteSelection();
      {
        ...
        return (
          ...
          this.selection.empty || this.setSelection(D.near(this.selection.$to)),
          this
        );
      }
    }
    ...
    if (n.indexOf('s') > -1) {
      ...
      if (t.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
        ...
        return i.isAtom || ((s = t.docView.descAt(l)) && !s.contentDOM)
          ? P.isSelectable(i)
            ? vt(t, new P(e < 0 ? t.state.doc.resolve(o.pos - i.nodeSize) : o))
            : Yn
...
function uc(t, e, n) {
  ...
  if (!o.parent.inlineContent) {
    let s = e < 0 ? o : i,
      l = r instanceof be ? D.near(s, e) : D.findFrom(s, e);
    return l ? vt(t, l) : !1;
  }
  return !1;
}
...
we.dragstart = (t, e) => {
  ...
  let o = t.state.selection,
    ...
    s;
  if (!(i && i.pos >= o.from && i.pos <= (o instanceof P ? o.to - 1 : o.to))) {
...
function Gm(t, e, n, r, o) {
    ...
    if (
      ...
      if (c.sel) {
        ...
        if (v && !v.eq(t.state.selection)) {
          let R = t.state.tr.setSelection(v);
  ...
  if (b) {
    if (m.pos == g.pos) {
      ...
      let v = k(t.state.tr.delete(E, w)),
        R = u.resolve(p.start).marksAcross(u.resolve(p.endA));
      ...
      let v = k(t.state.tr);
      (S.type == 'add' ? v.addMark(E, w, S.mark) : v.removeMark(E, w, S.mark),
        t.dispatch(v));
    } else if (
      ...
      let v = m.parent.textBetween(m.parentOffset, g.parentOffset),
        R = () => k(t.state.tr.insertText(v, E, w));
      t.someProp('handleTextInput', (T) => T(t, E, w, v, R)) || t.dispatch(R());
    }
  } else t.dispatch(k());
}
function xc(t, e, n) {
      ...
      for (let s = r.depth; ; s--) {
        ...
        if (l && l.slice.size < l.to - l.from) {
          if (e) {
            ...
            (a.setSelection(
              wn(i, 'end')
                ? D.findFrom(a.doc.resolve(a.mapping.map(o.pos, -1)), -1)
...
var hu = (t, e) => {
    ...
    return i == 0
      ? !1
      : ((o = n.before(i)), e && e(t.tr.setSelection(P.create(t.doc, o))), !0);
  },
...
function pu(t, e, n, r) {
  ...
  if (
    ...
    if (n) {
      let h = e.pos + i.nodeSize,
        p = x.empty;
      for (let y = s.length - 1; y >= 0; y--) p = x.from(s[y].create(null, p));
      p = x.from(o.copy(p));
      let m = t.tr.step(
  ...
  let u = i.type.spec.isolating || (r > 0 && a) ? null : D.findFrom(e, 1),
  ...
  if (c && wn(i, 'start', !0) && wn(o, 'end')) {
    ...
    if (h.canReplace(h.childCount, h.childCount, m.content)) {
      if (n) {
        let y = x.empty;
        for (let C = p.length - 1; C >= 0; C--) y = x.from(p[C].copy(y));
        let b = t.tr.step(
          new re(
            e.pos - p.length,
            e.pos + i.nodeSize,
              ...
              u.map((y) => {
                ...
                return [
                  y.name,
                  {
                    ...
                    validate: (C = y?.attribute) == null ? void 0 : C.validate,
                  },
                ];
              })
            ),
    ...
    (o.forEach(({ $from: d, $to: f }) => {
      ...
      t.doc.nodesBetween(h, p, (m, g) => {
        ...
        let y = Math.max(h, g),
          ...
          C = b - y;
        ((s += C),
          l.push(...m.marks.map((E) => ({ mark: E, from: y, to: b }))));
      });
    }),
    s === 0)
  )
  ...
  return (
    s.forEach((f) => {
      ...
      let p = a.state.tr,
        ...
        { commands: y, chain: b, can: C } = new oo({ editor: n, state: m });
      f.handler({
        state: m,
        range: g,
        match: h,
        ...
        apply(o, i, s) {
          ...
          return (
            !!a &&
              setTimeout(() => {
                let { text: u } = a;
                typeof u == 'string' ? (u = u) : (u = Ws(x.from(u), s.schema));
                let { from: d } = a,
                  f = d + u.length;
  ...
  return (
    n.doc.nodesBetween(r, o, (h, p) => {
      ...
      Pg(S, i.find, s).forEach((R) => {
        ...
        let T = w + R.index + 1,
          F = T + R[0].length,
          _ = { from: n.tr.mapping.map(T), to: n.tr.mapping.map(F) },
          G = i.handler({
            state: n,
            range: _,
            match: R,
    ...
    (u) =>
      new I({
        ...
        appendTransaction: (d, f, h) => {
          ...
          if (b) {
            let { text: w } = y;
            typeof w == 'string' ? (w = w) : (w = Ws(x.from(w), h.schema));
            let { from: k } = y,
              S = k + w.length,
              v = Lg(w);
            return a({ rule: u, state: h, from: k, to: { b: S }, pasteEvt: v });
          }
          let C = f.doc.content.findDiffStart(h.doc.content),
            E = f.doc.content.findDiffEnd(h.doc.content);
          if (!(!Rg(C) || !E || C === E.b))
            return a({ rule: u, state: h, from: C, to: E, pasteEvt: s });
        },
      })
  );
}
      ...
      if (o) {
        ...
        if (h) {
          ...
          let y = a.$from.parentOffset === 0,
            ...
            C = a.$from.node().content.size > 0;
          (y && b && C && (d = Math.max(0, d - 1)), r.replaceWith(d, f, g));
        }
...
var Iy =
    ...
    ({ tr: n, state: r, dispatch: o, editor: i }) => {
      ...
      if (o) {
        let { selection: y, storedMarks: b } = r,
          ...
          E = b || (y.$to.parentOffset && y.$from.marks());
        if ((n.split(a.pos, 2, g).scrollIntoView(), !E || !o)) return !0;
        let w = E.filter((k) => C.includes(k.type.name));
        n.ensureMarks(w);
      }
      return !0;
    },
  ...
  By =
    ...
    ({
      ...
      if (!C) return !1;
      let w = Ye((k) => vu(k.type.name, d))(m);
      if (C.depth >= 1 && w && C.depth - w.depth <= 1) {
        if (w.node.type === h) return c.liftListItem(p);
        if (vu(w.node.type.name, d) && h.validContent(w.node.content) && l)
          return a()
      ...
      return !n || !E || !l
        ...
        : a()
            .command(() => {
              let k = u().wrapInList(h, r),
                S = E.filter((v) => f.includes(v.type.name));
                      ...
                      g >= c &&
                        ...
                        s &&
                          ...
                          m.marks.forEach((y) => {
                            if (s === y.type) {
                              let b = Math.max(g, c),
                                C = Math.min(g + m.nodeSize, u);
                              n.addMark(b, C, s.create({ ...y.attrs, ...e }));
                            }
                          })));
                  }),
                f &&
...
`);
        ...
        ArrowDown: ({ editor: t }) => {
          ...
          return l === void 0
            ...
            : r.nodeAt(l)
              ? t.commands.command(
                  ({ tr: c }) => (c.setSelection(D.near(r.resolve(l))), !0)
                )
              : t.commands.exitCode();
        },
      };
      ...
      return {
        Enter: ({ editor: t }) => {
          ...
          let b = o.indexAfter(-3),
            C = er(y.contentMatchAt(b));
          if (!C || !y.canReplaceWith(b, b, C)) return !1;
          let E = C.createAndFill();
          if (!E) return !1;
          let { tr: w } = e,
            k = o.after(-2);
          w.replaceWith(k, k, E);
          let S = w.doc.resolve(k),
            v = D.near(S, 1);
          w.setSelection(v);
          let R = m,
            T = m + p.nodeSize;
                  ...
                  if (s) {
                    ...
                    if (a.nodeAfter)
                      a.nodeAfter.isTextblock
                        ...
                        : a.nodeAfter.isBlock
                          ? i.setSelection(P.create(i.doc, a.pos))
...
function G0({ groups: t }) {
  ...
  let p = M(d, ze);
  (M(p, ze, p), $(p, t.domain, d), $(h, t.domain, d), M(h, et, f), M(h, ze, p));
  let m = M(h, Dt);
  $(m, t.numeric, Fd);
  let g = M(s, ze),
    y = M(s, et);
    ...
    return new I({
      ...
      props: {
        handleDrop(u, d) {
          ...
          let f = Array.from(d.dataTransfer.files),
            h = lf({
              files: f,
              acceptedTypes: e,
              acceptedTypesValidationMessage: n,
          ...
          (Qo(u, 'form-processing-started', { message: a }),
            d.preventDefault(),
            d.stopPropagation());
          let p = u.posAtCoords({ left: d.clientX, top: d.clientY });
          return (
            f.forEach((m, g) => {
              (t.setEditable(!1),
                u.dom.dispatchEvent(
              ...
              r().upload(`componentFileAttachments.${l}.${y}`, m, () => {
                c(y).then((b) => {
                  b &&
                    ...
                    g === f.length - 1 && Qo(u, 'form-processing-finished'));
                });
              });
            }),
            !0
        ...
        handlePaste(u, d) {
          if (
            ...
            return !1;
          let f = Array.from(d.clipboardData.files),
            h = lf({
              files: f,
              acceptedTypes: e,
              acceptedTypesValidationMessage: n,
            ...
            : f.length
              ? (d.preventDefault(),
                ...
                f.forEach((p, m) => {
                  ...
                  let g = ('10000000-1000-4000-8000' + -1e11).replace(
                    /[018]/g,
                    (y) =>
                      (
                        y ^
                  ...
                  r().upload(`componentFileAttachments.${l}.${g}`, p, () => {
                    c(g).then((y) => {
                      y &&
                        (t
                          .chain()
...
function xb(t) {
  ...
  return (
    ...
    C < l.pos && E >= l.pos
      ? { range: { from: C, to: E }, query: g[0].slice(n.length), text: g[0] }
      : null
  );
}
...
function Sb({
  ...
  let g,
    y = h?.(),
    b = () => {
      let k = e.state.selection.$anchor.pos,
        S = e.view.coordsAtPos(k),
        { top: v, right: R, bottom: T, left: F } = S;
      try {
    ...
    C = (k, S) =>
      S
        ? () => {
            let v = t.getState(e.state),
              R = v?.decorationId,
              T = k.dom.querySelector(`[data-decoration-id="${R}"]`);
  ...
  function E(k, S) {
    var v;
    try {
      let T = t.getState(k.state),
        F = T?.decorationId
          ? k.dom.querySelector(`[data-decoration-id="${T.decorationId}"]`)
          : null,
        _ = {
          editor: e,
          ...
          items: [],
          command: (G) =>
            d({ editor: e, range: T?.range || { from: 0, to: 0 }, props: G }),
          decorationNode: F,
          clientRect: C(k, F),
        };
      (v = y?.onExit) == null || v.call(y, _);
    } catch {}
    let R = k.state.tr.setMeta(S, { exit: !0 });
    k.dispatch(R);
  }
  let w = new I({
    key: t,
    view() {
      return {
        update: async (k, S) => {
          var v, R, T, F, _, G, q;
          let B = (v = this.key) == null ? void 0 : v.getState(S),
            j = (R = this.key) == null ? void 0 : R.getState(k.state),
    ...
    state: {
      ...
      apply(k, S, v, R) {
        ...
        if (((B.composing = F), T && (G || e.view.composing))) {
          ...
          W && p({ editor: e, state: R, range: W.range, isActive: S.active })
            ? ((B.active = !0),
              (B.decorationId = S.decorationId ? S.decorationId : ie),
              (B.range = W.range),
              (B.query = W.query),
              (B.text = W.text))
            : (B.active = !1);
    ...
    props: {
      handleKeyDown(k, S) {
        var v, R, T, F;
        let { active: _, range: G } = w.getState(k.state);
        if (!_) return !1;
        if (S.key === 'Escape' || S.key === 'Esc') {
          let B = w.getState(k.state),
            j = (v = g?.decorationNode) != null ? v : null,
            W =
              j ??
              (B?.decorationId
                ? k.dom.querySelector(
          ...
          if (
            ((R = y?.onKeyDown) == null
              ? void 0
              : R.call(y, { view: k, event: S, range: B.range })) ||
            !1
          )
            return !0;
          let Te = {
          ...
          return ((T = y?.onExit) == null || T.call(y, Te), E(k, t), !0);
        }
        return (
          ((F = y?.onKeyDown) == null
            ? void 0
      ...
      decorations(k) {
        let { active: S, range: v, decorationId: R, query: T } = w.getState(k);
        if (!S) return null;
        let F = !T?.length,
          _ = [a];
        return (
...
function Ob(t) {
  ...
  for (let c = 0, u = 0; c < n; c++) {
    ...
    for (let p = 0; ; p++) {
      ...
      for (let C = 0; C < y; C++) {
        if (C + c >= n) {
          (i || (i = [])).push({ type: 'overlong_rowspan', pos: u, n: y - C });
          break;
        }
        let E = o + C * e;
        for (let w = 0; w < g; w++) {
...
var J = class xt extends D {
  ...
  replace(e, n = A.empty) {
    ...
    let i = D.findFrom(e.doc.resolve(e.mapping.slice(r).map(this.to)), -1);
    i && e.setSelection(i);
  }
  replaceWith(e, n) {
...
function ex(t, e, n, r, o, i, s) {
  ...
  if (i > e.height) {
    ...
    let f = a.row.create(null, x.from(d)),
      h = [];
...
var sh = (t) => ({
  ...
  async fn(e) {
    ...
    let d = ci(u),
      ...
      y = g ? 'top' : 'left',
      b = g ? 'bottom' : 'right',
      C = g ? 'clientHeight' : 'clientWidth',
      E = i.reference[p] + i.reference[h] - f[h] - i.floating[p],
      w = f[h] - i.reference[h],
    ...
    return (
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          ...
          let S = w
              .map((T) => {
                let F = Fe(T.placement);
                return [
                  T.placement,
                  F && u
                    ? T.overflows.slice(0, 2).reduce((_, G) => _ + G, 0)
                    : T.overflows[0],
                  T.overflows,
                ];
              })
            ...
            R =
              ((o = S.filter((T) =>
                ...
                : o[0]) || S[0][0];
          return R !== l
            ? { data: { index: y + 1, overflows: w }, reset: { placement: R } }
            : {};
        },
      }
    );
      ...
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          ...
          let y = Oe(o),
            b = je(l),
            C = Oe(l) === l,
            E = await (a.isRTL == null ? void 0 : a.isRTL(c.floating)),
            w = f || (C || !m ? [mr(l)] : eh(l)),
            k = p !== 'none';
        ...
        async fn(e) {
          ...
          function p() {
            ...
            if (d.length >= 2) {
              ...
              let g = Oe(n) === 'left',
                y = fe(...d.map((T) => T.right)),
                b = He(...d.map((T) => T.left)),
                C = d.filter((T) => (g ? T.left === b : T.right === y)),
                E = C[0].top,
                w = C[C.length - 1].bottom,
                k = b,
                S = y,
                v = S - k,
                R = w - E;
    ...
    t === void 0 && (t = {}),
    {
      ...
      async fn(e) {
        ...
        let b = m - u.top - u.bottom,
          ...
          v = w;
        if (
          ((n = e.middlewareData.shift) != null && n.enabled.x && (v = C),
          (r = e.middlewareData.shift) != null && r.enabled.y && (S = b),
          k && !f)
        ) {
          let T = fe(u.left, 0),
            F = fe(u.right, 0),
            ...
            G = fe(u.bottom, 0);
          h
            ? (v = p - 2 * (T !== 0 || F !== 0 ? T + F : fe(u.left, u.right)))
            : (S = m - 2 * (_ !== 0 || G !== 0 ? _ + G : fe(u.top, u.bottom)));
        }
        await a({ ...e, availableWidth: v, availableHeight: S });
        let R = await s.getDimensions(l.floating);
        return p !== R.width || m !== R.height ? { reset: { rects: !0 } } : {};
      },
    }
  );
};
  ...
  if (i) {
    ...
    for (; m && r && h !== p; ) {
      let g = En(m),
        ...
        b = Ve(m),
        C = y.left + (m.clientLeft + parseFloat(b.paddingLeft)) * g.x,
        E = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
      ((a *= g.x),
        (c *= g.y),
        (u *= g.x),
        (d *= g.y),
  ...
  ...(u.length
    ? [
        uf.configure({
          ...
          suggestion: Bh({ mergeTags: u, noMergeTagSearchResultsMessage: d }),
        }),
      ]
    : []),
  Il,
...
function aw({
  ...
  return {
    ...
    async init() {
      ((w = new rd({
        ...
        Object.keys(E).forEach((S) => {
          let v = this.$refs[`floatingToolbar::${S}`];
          if (!v) {
          ...
          w.registerPlugin(
            Ql({
              ...
              shouldShow: ({ editor: R }) => R.isFocused && R.isActive(S),
      ...
      let k = Alpine.debounce(() => this.$wire.commit(), u ?? 300);
      (w.on('update', ({ editor: S }) =>
        ...
        window.addEventListener('rich-editor-file-validation-message', (S) => {
          S.detail.livewireId === d &&
            S.detail.key === s &&
            ((this.isUploadingFile = !1),
            (this.fileValidationMessage = S.detail.validationMessage),
            S.stopPropagation());
        }),
    ...
    setEditorSelection(k) {
      k &&
        ...
        w
          ...
          .command(
            ({ tr: S }) => (
              S.setSelection(D.fromJSON(w.state.doc, this.editorSelection)),
              !0
            )
          )
          .run());
    ...
    runEditorCommands({ commands: k, editorSelection: S }) {
      ...
      let v = w.chain();
      (k.forEach((R) => (v = v[R.name](...(R.arguments ?? [])))), v.run());
    },
    togglePanel(k = null) {
    ...
    isPanelActive(k = null) {
      return k === null ? this.activePanel !== null : this.activePanel === k;
    },
    insertMergeTag(k) {
      w.chain()
        .focus()
