...
function ua(t, e, n, r) {
  for (let o = t.childCount, i = e.childCount; ; ) {
    ...
    if (s.isText && s.text != l.text) {
      ...
      for (
        ;
        c < u && s.text[s.text.length - c - 1] == l.text[l.text.length - c - 1];
...
function ha(t, e, n, r) {
  ...
  if (o == e.index(r) && r < t.depth - n.openStart) {
    ...
    if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
      ...
      return Bt(
        s,
        l.cut(0, t.parentOffset).append(n.content).append(l.cut(e.parentOffset))
      );
    } else {
      let { start: s, end: l } = $h(n, t);
...
function ma(t, e, n, r, o) {
  let i = t.depth > o && Ci(t, e, o + 1),
    s = r.depth > o && Ci(n, r, o + 1),
    l = [];
  return (
    Nn(null, t, o, l),
...
function Gh(t) {
  ...
  function n(r) {
    ...
    let i = (e[r.join(',')] = new Ft(r.indexOf(t.length - 1) > -1));
...
function ka(t, e) {
  let n = Object.create(null);
  if (e) for (let r in e) n[r] = new Ai(t, r, e[r]);
  return n;
}
var Tr = class t {
  constructor(e, n, r) {
...
var Ai = class {
    constructor(e, n, r) {
      ((this.hasDefault = Object.prototype.hasOwnProperty.call(r, 'default')),
        ...
        (this.validate =
          typeof r.validate == 'string' ? Xh(e, n, r.validate) : r.validate));
    }
    get isRequired() {
...
var Ue = class t {
  ...
  ep = { head: !0, noscript: !0, object: !0, script: !0, style: !0, title: !0 },
  va = { ol: !0, ul: !0 },
  Pn = 1,
  Ei = 2,
  Rn = 4;
...
var sn = class {
    ...
    finish(e) {
      ...
      return (
        !e && this.match && (n = n.append(this.match.fillBefore(w.empty, !0))),
      ...
      for (let l = 0; l < this.ranges.length; l += 3) {
        ...
        if (e <= d) {
          let f = c ? (e == a ? -1 : e == d ? 1 : n) : n,
            h = a + o + (f < 0 ? 0 : u);
          if (r) return h;
          let p = e == (n < 0 ? a : d) ? null : ip(l / 3, e - a),
            m = e == a ? Na : e == d ? Oa : Er;
  ...
  (t.doc.nodesBetween(e, n, (s, l) => {
    ...
    if (a && a.length) {
      ...
      for (let u = 0; u < a.length; u++) {
        ...
        f
          ? ((f.to = c), (f.step = i))
          : o.push({ style: d, from: Math.max(l, e), to: c, step: i });
      }
    }
  }),
  ...
  for (let a = 0; a < i.childCount; a++) {
    ...
    if (!d) s.push(new pe(l, u, A.empty));
      ...
      for (let f = 0; f < c.marks.length; f++)
        n.allowsMarkType(c.marks[f].type) || t.step(new lt(l, u, c.marks[f]));
...
var Pi = class {
    ...
    for (let n = 1; n <= 2; n++)
      for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        let o,
          i = null;
        r
          ? ((i = Ni(this.unplaced.content, r - 1).firstChild), (o = i.content))
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (
            n == 1 &&
            (s
              ? c.matchType(s.type) || (d = c.fillBefore(w.from(s), !1))
  ...
  placeNodes({
    ...
    this.unplaced = p
      ? e == 0
        ? A.empty
        : new A(In(s.content, e - 1, 1), e - 1, h < 0 ? s.openEnd : e - 1)
...
function In(t, e, n) {
  return e == 0
    ...
    : t.replaceChild(0, t.firstChild.copy(In(t.firstChild.content, e - 1, n)));
}
function Ln(t, e, n) {
  return e == 0
    ? t.append(n)
...
function Ba(t, e, n) {
  ...
  return (
    ...
    e > 0 &&
      ...
      n <= 0 &&
        (r = r.append(
          t.type.contentMatch.matchFragment(r).fillBefore(w.empty, !0)
        ))),
    t.copy(r)
  );
}
  ...
  R = class {
    ...
    replace(e, n = A.empty) {
      ...
      for (let l = 0; l < s.length; l++) {
        ...
        (e.replaceRange(u.map(a.pos), u.map(c.pos), l ? A.empty : n),
          l == 0 && Va(e, i, (r ? r.isInline : o && o.isTextblock) ? -1 : 1));
      }
    }
    replaceWith(e, n) {
    ...
    static findFrom(e, n, r = !1) {
      ...
      for (let i = e.depth - 1; i >= 0; i--) {
        let s =
          n < 0
            ? dn(e.node(0), e.node(i), e.before(i + 1), e.index(i), n, r)
            : dn(e.node(0), e.node(i), e.after(i + 1), e.index(i) + 1, n, r);
        if (s) return s;
      }
      return null;
    }
...
var O = class t extends R {
  ...
  static between(e, n, r) {
    ...
    if (((!r || o) && (r = o >= 0 ? 1 : -1), !n.parent.inlineContent)) {
      let i = R.findFrom(n, r, !0) || R.findFrom(n, -r, !0);
      if (i) n = i.$head;
...
var Hi = class t {
    ...
    resolve(e) {
      let n = e.resolve(this.anchor),
        r = n.nodeAfter;
      return r && D.isSelectable(r) ? new D(n) : R.near(n);
    }
  },
  be = class t extends R {
    constructor(e) {
...
function dn(t, e, n, r, o, i = !1) {
  ...
  for (let s = r - (o > 0 ? 0 : 1); o > 0 ? s < e.childCount : s >= 0; s += o) {
    ...
    if (l.isAtom) {
      ...
      let a = dn(t, l, n + o, o < 0 ? l.childCount : 0, o, i);
      if (a) return a;
    }
    n += l.nodeSize * o;
  }
...
function Va(t, e, n) {
  ...
  (i.forEach((l, a, c, u) => {
    ...
    t.setSelection(R.near(t.doc.resolve(s), n)));
}
var _a = 1,
  Dr = 2,
  Wa = 4,
    ...
    replaceSelectionWith(e, n = !0) {
      ...
      return (
        n &&
          (e = e.mark(
            this.storedMarks ||
              (r.empty ? r.$from.marks() : r.$from.marksAcross(r.$to) || K.none)
          )),
    ...
    insertText(e, n, r) {
          ...
          : this.deleteSelection();
      {
        ...
        return (
          ...
          this.selection.empty || this.setSelection(R.near(this.selection.$to)),
          this
        );
      }
    }
...
var Vt = class {
  ...
  Ap = [
    ...
    new Vt('selection', {
      init(t, e) {
        return t.selection || R.atStart(e.doc);
      },
      apply(t) {
        return t.selection;
      },
        ...
        n &&
          n.forEach((r) => {
            ...
            (this.plugins.push(r),
              ...
              r.spec.state && this.fields.push(new Vt(r.key, r.spec.state, r)));
          }));
    }
  },
  Ir = class t {
      ...
      return (
        o.fields.forEach((s) => {
          if (s.name == 'doc') i.doc = le.fromJSON(e.schema, n.doc);
            ...
            i.selection = R.fromJSON(i.doc, n.selection);
...
var Kr = function (t) {
  return (
    t.focusNode && qt(t.focusNode, t.focusOffset, t.anchorNode, t.anchorOffset)
  );
};
function _t(t, e) {
...
var Je = typeof navigator < 'u' ? navigator : null,
  ...
  ke = !!(Tc || Ji || Ui),
  Tt = Tc ? document.documentMode : Ji ? +Ji[1] : Ui ? +Ui[1] : 0,
  Pe = !ke && /gecko\/(\d+)/i.test(Et);
Pe && +(/Firefox\/(\d+)/.exec(Et) || [0, 0])[1];
var qi = !ke && /Chrome\/(\d+)/.exec(Et),
  ge = !!qi,
  Ac = qi ? +qi[1] : 0,
  xe = !ke && !!Je && /Apple Computer/.test(Je.vendor),
  bn = xe && (/Mobile\/\w+/.test(Et) || (!!Je && Je.maxTouchPoints > 2)),
  Re = bn || (Je ? /Mac/.test(Je.platform) : !1),
  Lp = Je ? /Win/.test(Je.platform) : !1,
      ...
      if (p.top <= s && p.bottom >= l) {
        ...
        if (m < r) {
          ((n = u),
            ...
            u.nodeType == 1 &&
              m &&
              (i = d + (e.left >= (p.left + p.right) / 2 ? 1 : 0)));
          continue;
        }
      } else
        p.top > e.top &&
...
function Dc(t, e, n) {
  let { node: r, offset: o, atom: i } = t.docView.domFromPos(e, n < 0 ? -1 : 1),
    s = Yn || Pe;
  if (r.nodeType == 3)
    if (s && (Jp.test(r.nodeValue) || (n < 0 ? !o : o == r.nodeValue.length))) {
      let a = Ct(ut(r, o, o), n);
      if (Pe && o && /\s/.test(r.nodeValue[o - 1]) && o < r.nodeValue.length) {
...
var Ie = 0,
  ...
  Gt = class {
    ...
    domFromPos(e, n) {
      ...
      for (
        let i;
        r && !(i = this.children[r - 1]).size && i instanceof Lr && i.side >= 0;
        r--
      );
      if (n <= 0) {
        let i,
...
`
            ...
            for (let m = h, g; m; m = m.parentNode) {
              if ((g = m.nextSibling)) {
                g.nodeName == 'BR' &&
                  (l = a = { node: g.parentNode, offset: ue(g) + 1 });
                break;
              }
              let y = m.pmViewDesc;
  ...
  xn = class t extends Gt {
    ...
    static create(e, n, r, o) {
      ...
      return (
        (!s || !s.dom) &&
          (s = it.renderSpec(document, n.type.spec.toDOM(n, r), null, n.attrs)),
  ...
  At = class t extends Gt {
        ...
        (c, u, d) => {
          (c.spec.marks
            ...
            : c.type.side >= 0 &&
              !d &&
              a.syncToMarks(
                u == this.node.childCount ? K.none : this.node.child(u).marks,
                r,
                e
              ),
            a.placeWidget(c, e, o));
    ...
    localCompositionInfo(e, n) {
      ...
      if (this.node.inlineContent) {
        let s = i.nodeValue,
          l = rm(this.node.content, s, r - n, o - n);
  ...
  syncToMarks(e, n, r) {
    ...
    for (; i < e.length; ) {
      ...
      if (l > -1)
        ...
        let a = xn.create(this.top, e[i], n, r);
      ...
      if (a instanceof At) {
        ...
        if (!f && (d = this.recreateWrapper(a, e, n, r, o, s)))
          return (
            ...
            d.contentDOM &&
              ((d.dirty = Wt), d.updateChildren(o, s + 1), (d.dirty = Ie)),
            (this.changed = !0),
            this.index++,
            !0
          );
...
function zc(t) {
  return t.editable
    ? t.hasFocus()
    : Fc(t) && document.activeElement && document.activeElement.contains(t.dom);
}
function ft(t, e = !1) {
  ...
  if (r instanceof O)
    if (n.indexOf('s') > -1) {
      ...
      if (t.endOfTextblock(e > 0 ? 'forward' : 'backward')) {
        let o = es(t.state, e);
        return o && o instanceof D ? vt(t, o) : !1;
        ...
        return i.isAtom || ((s = t.docView.descAt(l)) && !s.contentDOM)
          ? D.isSelectable(i)
            ? vt(t, new D(e < 0 ? t.state.doc.resolve(o.pos - i.nodeSize) : o))
            : Yn
              ? vt(t, new O(t.state.doc.resolve(e < 0 ? l : l + i.nodeSize)))
              : !1
          : !1;
      }
    } else return !1;
...
function lm(t) {
  ...
  let o,
    ...
    s = !1;
  for (
    Pe && n.nodeType == 1 && r < Fr(n) && jn(n.childNodes[r], -1) && (s = !0);
    ;
...
function uc(t, e, n) {
  ...
  if (!o.parent.inlineContent || t.endOfTextblock(e < 0 ? 'up' : 'down')) {
    let s = es(t.state, e);
    if (s && s instanceof D) return vt(t, s);
  }
  if (!o.parent.inlineContent) {
    let s = e < 0 ? o : i,
      l = r instanceof be ? R.near(s, e) : R.findFrom(s, e);
    return l ? vt(t, l) : !1;
  }
  return !1;
}
...
`
  ...
  else if (((l = A.maxOpen(mm(l.content, o), !0)), l.openStart || l.openEnd)) {
    let d = 0,
      f = 0;
    for (
    ...
    if (
      (t.forEach((l) => {
        ...
        let a = o.findWrapping(l.type),
          c;
        if (!a) return (s = null);
        if ((c = s.length && i.length && Wc(a, i, l, s[s.length - 1], 0)))
          s[s.length - 1] = c;
        else {
  ...
  for (let e in we) {
    ...
    t.dom.addEventListener(
      ...
      (t.input.eventHandlers[e] = (r) => {
        Cm(t, r) && !ps(t, r) && (t.editable || !(r.type in Se)) && n(t, r);
      }),
  ...
  t.someProp('handleDOMEvents', (e) => {
    for (let n in e)
      t.input.eventHandlers[n] ||
        t.dom.addEventListener(n, (t.input.eventHandlers[n] = (r) => ps(t, r)));
  });
}
function ps(t, e) {
    ...
    if (
      ...
      ((t.input.lastIOSEnter = r),
        (t.input.lastIOSEnterFallbackTimeout = setTimeout(() => {
          t.input.lastIOSEnter == r &&
            (t.someProp('handleKeyDown', (o) => o(t, _t(13, 'Enter'))),
...
Se.keypress = (t, e) => {
  let n = e;
  if (qc(t, n) || !n.charCode || (n.ctrlKey && !n.altKey) || (Re && n.metaKey))
    return;
...
function Am(t, e) {
  ...
  return o != null ? (gn(t, D.create(t.state.doc, o), 'pointer'), !0) : !1;
}
...
function Rm(t, e, n) {
  ...
  for (let i = o.depth + 1; i > 0; i--) {
    ...
    else if (D.isSelectable(s)) gn(t, D.create(r, l), 'pointer');
    else continue;
    return !0;
  }
}
      ...
      this.allowDefault || !n
        ...
        : Em(this.view, n.pos, n.inside, e, this.selectNode)
          ...
          : e.button == 0 &&
            ...
            ? (gn(
                this.view,
                R.near(this.view.state.doc.resolve(n.pos)),
                'pointer'
              ),
              e.preventDefault())
            : Mt(this.view, 'pointer'));
...
function Pm(t) {
  ...
  let n = Np(e.focusNode, e.focusOffset),
    r = Rp(e.focusNode, e.focusOffset);
  if (n && r && n != r) {
    let o = r.pmViewDesc,
...
function $r(t, e = !1) {
  if (!(dt && t.domObserver.flushingSoon >= 0)) {
    if (
      (t.domObserver.forceFlush(), Yc(t), e || (t.docView && t.docView.dirty))
    ) {
      let n = ds(t),
        r = t.state.selection;
      return (
...
function zm(t, e) {
  ...
  setTimeout(() => {
    (t.focus(),
      ...
      n ? Un(t, r.value, null, o, e) : Un(t, r.textContent, r.innerHTML, o, e));
  }, 50);
}
...
we.dragstart = (t, e) => {
  ...
  let o = t.state.selection,
    ...
    s;
  if (!(i && i.pos >= o.from && i.pos <= (o instanceof D ? o.to - 1 : o.to))) {
    if (r && r.mightDrag) s = D.create(t.state.doc, r.mightDrag.pos);
      ...
      d &&
        ...
        d != t.docView &&
        (s = D.create(t.state.doc, d.posBefore));
    }
  }
  let l = (s || t.state.selection).content(),
    { dom: a, text: c, slice: u } = hs(t, l);
...
Se.drop = (t, e) => {
  ...
  if (
    ...
    (c.mapping.maps[c.mapping.maps.length - 1].forEach((m, g, y, b) => (p = b)),
...
var Vm = {
  ...
  cs = class {
    ...
    start() {
      (this.observer &&
        (this.observer.takeRecords(), this.observer.observe(this.view.dom, Vm)),
        this.onCharData &&
    ...
    flush() {
      ...
      if (Pe && a.length) {
        ...
        if (u.length == 2) {
          ...
          for (let f of u) {
            let h = f.parentNode;
            h && h.nodeName == 'LI' && (!d || Km(e, d) != h) && f.remove();
          }
        }
      }
      let c = null;
    ...
    registerMutation(e, n) {
      ...
      if (e.type == 'childList') {
        ...
        let s = o && o.parentNode == e.target ? ue(o) + 1 : 0,
          ...
          a =
            i && i.parentNode == e.target ? ue(i) : e.target.childNodes.length,
...
function Gm(t, e, n, r, o) {
  ...
  if (
    ...
    ((bn && t.input.lastIOSEnter > Date.now() - 225) || dt) &&
      o.some((M) => M.nodeType == 1 && !qm.test(M.nodeName)) &&
      (!p || p.endA >= p.endB) &&
      t.someProp('handleKeyDown', (M) => M(t, _t(13, 'Enter'))))
  ) {
    t.input.lastIOSEnter = 0;
    return;
  }
  if (!p)
    if (
      ...
      if (c.sel) {
        let M = xc(t, t.state.doc, c.sel);
        if (M && !M.eq(t.state.selection)) {
          let I = t.state.tr.setSelection(M);
          (i && I.setMeta('composition', i), t.dispatch(I));
        }
      }
      return;
    }
  ...
  if (
    ...
    t.someProp('handleKeyDown', (M) => M(t, _t(8, 'Backspace')))
  ) {
        ...
        v &&
          !(
            (ge &&
              ...
              (v.head == C || v.head == I.mapping.map(S) - 1)) ||
            (ke && v.empty && v.head == C)
          ) &&
          I.setSelection(v);
      }
  ...
  if (b) {
    if (m.pos == g.pos) {
      ke &&
        Tt <= 11 &&
        m.parentOffset == 0 &&
        (t.domObserver.suppressSelectionUpdates(), setTimeout(() => ft(t), 20));
      let M = T(t.state.tr.delete(C, S)),
        I = u.resolve(p.start).marksAcross(u.resolve(p.endA));
      (I && M.ensureMarks(I), t.dispatch(M));
    } else if (
      p.endA == p.endB &&
      (E = Ym(
      ...
      let M = T(t.state.tr);
      (E.type == 'add' ? M.addMark(C, S, E.mark) : M.removeMark(C, S, E.mark),
        t.dispatch(M));
    } else if (
      ...
      let M = m.parent.textBetween(m.parentOffset, g.parentOffset),
        I = () => T(t.state.tr.insertText(M, C, S));
      t.someProp('handleTextInput', (v) => v(t, C, S, M, I)) || t.dispatch(I());
    }
  } else t.dispatch(T());
}
function xc(t, e, n) {
...
function Qm(t, e, n, r, o) {
  ...
  if (s < i && t.size < e.size) {
    let a = r <= i && r >= s ? i - r : 0;
    ((i -= a),
      i && i < e.size && wc(e.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
      (l = i + (l - s)),
      (s = i));
  } else if (l < i) {
    let a = r <= i && r >= l ? i - r : 0;
    ((i -= a),
      i && i < t.size && wc(t.textBetween(i - 1, i + 1)) && (i += a ? 1 : -1),
      (s = i + (s - l)),
      (l = i));
  }
...
var qn = class {
  constructor(e, n) {
    ((this._root = null),
      ...
      (this.docView = tc(this.state.doc, Sc(this), Wi(this), this.dom, this)),
      (this.domObserver = new cs(this, (r, o, i, s) => Gm(this, r, o, i, s))),
  ...
  update(e) {
    ...
    let n = this._props;
    ((this._props = e),
      e.plugins && (e.plugins.forEach(Mc), (this.directPlugins = e.plugins)),
  ...
  updateStateInner(e, n) {
    ...
    let f =
      u == 'preserve' && s && this.dom.style.overflowAnchor == null && Fp(this);
    if (s) {
...
var ht = {
  ...
  tg = typeof navigator < 'u' && /Mac/.test(navigator.platform),
  ng =
    typeof navigator < 'u' &&
...
var oe;
for (oe = 65; oe <= 90; oe++)
  ((ht[oe] = String.fromCharCode(oe + 32)), (qr[oe] = String.fromCharCode(oe)));
var oe;
...
var rg =
  ...
  og = typeof navigator < 'u' && /Win/.test(navigator.platform);
function ig(t) {
  let e = t.split(/-(?!$)/),
    n = e[e.length - 1];
  n == 'Space' && (n = ' ');
...
function ru(t) {
  return new P({ props: { handleKeyDown: Xn(t) } });
}
function Xn(t) {
  let e = sg(t);
  return function (n, r) {
...
var ws = (t, e, n) => {
    ...
    if (r.parent.content.size == 0 && (wn(i, 'end') || D.isSelectable(i)))
      for (let s = r.depth; ; s--) {
        let l = $n(t.doc, r.before(s), r.after(s), A.empty);
        if (l && l.slice.size < l.to - l.from) {
          if (e) {
            let a = t.tr.step(l);
            (a.setSelection(
              wn(i, 'end')
                ? R.findFrom(a.doc.resolve(a.mapping.map(o.pos, -1)), -1)
...
var Cs = (t, e, n) => {
    ...
    let i = o.nodeAfter;
    if (pu(t, o, e, 1)) return !0;
    if (r.parent.content.size == 0 && (wn(i, 'start') || D.isSelectable(i))) {
      let s = $n(t.doc, r.before(), r.after(), A.empty);
      if (s && s.slice.size < s.to - s.from) {
        if (e) {
          let l = t.tr.step(s);
          (l.setSelection(
            wn(i, 'start')
              ? R.findFrom(l.doc.resolve(l.mapping.map(o.pos)), 1)
  ...
  vs = (t, e, n) => {
    ...
    return !s || !D.isSelectable(s)
      ? !1
      : (e && e(t.tr.setSelection(D.create(t.doc, i.pos)).scrollIntoView()),
        !0);
  };
function Ms(t) {
  if (!t.parent.type.spec.isolating)
...
var Es = (t, e) => {
  ...
  Os = (t, e) => {
    ...
    if (n instanceof be || r.parent.inlineContent || o.parent.inlineContent)
      return !1;
    let i = As(o.parent.contentMatchAt(o.indexAfter()));
...
function lg(t) {
  return (e, n) => {
    ...
    for (let h = r.depth; ; h--)
      if (r.node(h).isBlock) {
        ((a = r.end(h) == r.pos + (r.depth - h)),
          ...
          (l = As(r.node(h - 1).contentMatchAt(r.indexAfter(h - 1)))));
    ...
    if (
      (f || ((i[0] = l ? { type: l } : null), (f = Ae(u.doc, d, i.length, i))),
      !f)
    )
      return !1;
...
var hu = (t, e) => {
    ...
    return i == 0
      ? !1
      : ((o = n.before(i)), e && e(t.tr.setSelection(D.create(t.doc, o))), !0);
  },
  cg = (t, e) => (e && e(t.tr.setSelection(new be(t.doc))), !0);
function ug(t, e, n) {
  let r = e.nodeBefore,
    o = e.nodeAfter,
    i = e.index();
...
function pu(t, e, n, r) {
  ...
  let u = i.type.spec.isolating || (r > 0 && a) ? null : R.findFrom(e, 1),
...
function mu(t) {
  return function (e, n) {
    ...
    return o.node(i).isTextblock
      ? (n &&
          n(e.tr.setSelection(O.create(e.doc, t < 0 ? o.start(i) : o.end(i)))),
        !0)
      : !1;
  };
}
...
function pg(t, e, n, r) {
  ...
  return (
    Ne(o.doc, a.pos) && a.nodeBefore.type == a.nodeAfter.type && o.join(a.pos),
    e(o.scrollIntoView()),
    !0
  );
}
...
var gg = Object.defineProperty,
  Au = (t, e) => {
    for (var n in e) gg(t, n, { get: e[n], enumerable: !0 });
  };
function ro(t) {
...
function L(t, e, n) {
  return t.config[e] === void 0 && t.parent
    ...
    : typeof t.config[e] == 'function'
      ? t.config[e].bind({ ...n, parent: t.parent ? L(t.parent, e, n) : null })
      : t.config[e];
}
function _s(t) {
  return t
...
function wg(t, e) {
  ...
  let r = Ru(t),
    ...
    s = (n = o.find((c) => L(c, 'topNode'))) == null ? void 0 : n.name,
    l = Object.fromEntries(
      o.map((c) => {
        ...
        let m = L(c, 'renderHTML', d);
        m && (h.toDOM = (y) => m({ node: y, HTMLAttributes: to(y, u) }));
        let g = L(c, 'renderText', d);
    ...
    a = Object.fromEntries(
      i.map((c) => {
        ...
        let m = L(c, 'renderHTML', d);
        return (
          m && (h.toDOM = (g) => m({ mark: g, HTMLAttributes: to(g, u) })),
          [c.name, h]
        );
      })
    );
...
`,
  ...
  return (
    t.nodesBetween(r, o, (a, c, u, d) => {
      ...
      if (h)
        return (
          u && (l += h({ node: a, pos: c, parent: u, index: d, range: e })),
          !1
        );
      a.isText &&
        (l +=
...
function no(t, e, n = { strict: !0 }) {
  ...
  return r.length
    ? r.every((o) =>
        n.strict ? e[o] === t[o] : Js(e[o]) ? e[o].test(t[o]) : e[o] === t[o]
      )
    : !0;
}
function Bu(t, e, n = {}) {
  return t.find(
    (r) =>
      r.type === e &&
      no(Object.fromEntries(Object.keys(n).map((o) => [o, r.attrs[o]])), n)
  );
}
function ku(t, e, n = {}) {
  return !!Bu(t, e, n);
    ...
    (o.forEach(({ $from: d, $to: f }) => {
      ...
      t.doc.nodesBetween(h, p, (m, g) => {
        ...
        let y = Math.max(h, g),
          ...
          x = b - y;
        ((s += x),
          l.push(...m.marks.map((C) => ({ mark: C, from: y, to: b }))));
      });
    }),
    s === 0)
  )
...
function tr(t, { checkChildren: e = !0, ignoreWhitespace: n = !1 } = {}) {
  ...
  if (e) {
    ...
    return (
      t.content.forEach((i) => {
        o !== !1 &&
          (tr(i, { ignoreWhitespace: n, checkChildren: e }) || (o = !1));
      }),
      o
    );
  }
        ...
        apply(o, i, s) {
          ...
          return (
            !!a &&
              setTimeout(() => {
                let { text: u } = a;
                typeof u == 'string' ? (u = u) : (u = Ws(w.from(u), s.schema));
                let { from: d } = a,
                  f = d + u.length;
...
var Ys = class {
    ...
    get storage() {
      return {
        ...(U(
          L(this, 'addStorage', { name: this.name, options: this.options })
        ) || {}),
      };
    }
    configure(t = {}) {
...
function Ig(t) {
  ...
  return (
    n.doc.nodesBetween(r, o, (h, p) => {
      ...
      let E = h.isText
        ? h.text || ''
        : h.textBetween(S - p, T - p, void 0, '\uFFFC');
      Pg(E, i.find, s).forEach((I) => {
        if (I.index === void 0) return;
        let v = S + I.index + 1,
          F = v + I[0].length,
          _ = { from: n.tr.mapping.map(v), to: n.tr.mapping.map(F) },
          G = i.handler({
            state: n,
            range: _,
            match: I,
    ...
    (u) =>
      new P({
        ...
        appendTransaction: (d, f, h) => {
          ...
          if (b) {
            let { text: S } = y;
            typeof S == 'string' ? (S = S) : (S = Ws(w.from(S), h.schema));
            let { from: T } = y,
              E = T + S.length,
              M = Lg(S);
            return a({ rule: u, state: h, from: T, to: { b: E }, pasteEvt: M });
          }
          let x = f.doc.content.findDiffStart(h.doc.content),
            C = f.doc.content.findDiffEnd(h.doc.content);
          if (!(!Rg(x) || !C || x === C.b))
            return a({ rule: u, state: h, from: x, to: C, pasteEvt: s });
        },
      })
  );
}
    ...
    return js([...this.extensions].reverse())
      .map((r) => {
        ...
        if (
          (r.type === 'mark' &&
            L(r, 'exitable', o) &&
            (l.ArrowRight = () => ne.handleExit({ editor: t, mark: r })),
          s)
        ) {
        ...
        if (Cu(r, t.options.enableInputRules) && c) {
          let f = c();
          if (f && f.length) {
            let h = Og({ editor: t, rules: f }),
              p = Array.isArray(h) ? h : [h];
            i.push(...p);
          }
        }
        let u = L(r, 'addPasteRules', o);
        if (Cu(r, t.options.enablePasteRules) && u) {
          let f = u();
          if (f && f.length) {
            let h = Bg({ editor: t, rules: f });
            i.push(...h);
          }
        }
        let d = L(r, 'addProseMirrorPlugins', o);
        if (d) {
          let f = d();
          i.push(...f);
        }
  ...
  setupExtensions() {
    ...
    ((this.editor.extensionStorage = Object.fromEntries(
      ...
      t.forEach((e) => {
        ...
        let o = L(e, 'onBeforeCreate', r),
          i = L(e, 'onCreate', r),
          s = L(e, 'onUpdate', r),
          l = L(e, 'onSelectionUpdate', r),
          a = L(e, 'onTransaction', r),
          c = L(e, 'onFocus', r),
          u = L(e, 'onBlur', r),
          d = L(e, 'onDestroy', r);
...
var Zg =
  ...
  ey = (t, e) => (n) => t.every((r, o) => e(r, { ...n, index: o })),
  ty =
    (t, e) =>
    ({ tr: n, commands: r }) =>
  ...
  ay =
    ...
    ({ state: t, dispatch: e, tr: n }) => {
      try {
        let r = $t(t.doc, t.selection.$from.pos, -1);
              ...
              r.doc.nodesBetween(a.$from.pos, a.$to.pos, (c, u) => {
                (i &&
                  ...
                  s &&
                    ...
                    c.marks.forEach((d) => {
                      s === d.type &&
                        n.addMark(u, u + c.nodeSize, s.create(Mu(d.attrs, e)));
                    }));
              });
            }),
          !0)
      ...
      t.doc.nodesBetween(l.pos, a.pos, (u, d, f) => {
        ...
        if (u.isInline) {
          let h = !f || f.type.allowsMarkType(n),
            p =
              !!n.isInSet(u.marks) || !u.marks.some((m) => m.type.excludes(n));
          c = h && p;
        }
        return !c;
      }),
...
var Iy =
    ...
    ({ tr: e, state: n, dispatch: r, editor: o }) => {
      ...
      if (
        (!h &&
          !p &&
          Ae(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) &&
    ...
    ({ tr: n, state: r, dispatch: o, editor: i }) => {
      ...
      if (
        ...
        if (o) {
          ...
          let T = a.before(a.depth - (b - 1));
          n.replace(T, a.after(-x), new A(y, 4 - b, 0));
          let E = -1;
          (n.doc.nodesBetween(T, n.doc.content.size, (M, I) => {
            if (E > -1) return !1;
            M.isTextblock && M.content.size === 0 && (E = I + 1);
          }),
            E > -1 && n.setSelection(O.near(n.doc.resolve(E))),
            n.scrollIntoView());
        }
        return !0;
      }
      ...
      if (o) {
        ...
        let S = C.filter((T) => x.includes(T.type.name));
        n.ensureMarks(S);
      }
      return !0;
    },
  ...
  By =
    ...
    ({
      ...
      if (!x) return !1;
      let S = Ye((T) => vu(T.type.name, d))(m);
      if (x.depth >= 1 && S && x.depth - S.depth <= 1) {
        if (S.node.type === h) return c.liftListItem(p);
        if (vu(S.node.type.name, d) && h.validContent(S.node.content) && l)
          return a()
      ...
      return !n || !C || !l
        ...
        : a()
            .command(() => {
              let T = u().wrapInList(h, r),
                E = C.filter((M) => f.includes(M.type.name));
              return (i.ensureMarks(E), T ? !0 : c.clearNodes());
            })
            .wrapInList(h, r)
            .command(() => Bs(i, h))
            .command(() => zs(i, h))
          ...
          o &&
            n.selection.ranges.forEach((a) => {
              ...
              (n.selection.empty
                ...
                : r.doc.nodesBetween(c, u, (m, g) => {
                    (g < c &&
                      ...
                      g >= c &&
                        ...
                        (i &&
                          i === m.type &&
                          n.setNodeMarkup(g, void 0, { ...m.attrs, ...e }),
                        s &&
                          m.marks.length &&
                          m.marks.forEach((y) => {
                            if (s === y.type) {
                ...
                f &&
                  (d !== void 0 &&
                    n.setNodeMarkup(d, void 0, { ...f.attrs, ...e }),
                  s &&
                    f.marks.length &&
                    f.marks.forEach((m) => {
                      s === m.type &&
                        n.addMark(h, p, s.create({ ...m.attrs, ...e }));
                    })));
            }),
          !0)
        : !1;
            ...
            let y = f.slice(p).map(h.from, -1),
              ...
              S =
                (m = u.doc.nodeAt(y - 1)) == null
                  ? void 0
                  : m.marks.some((E) => E.eq(h.mark)),
              T =
                (g = u.doc.nodeAt(b)) == null
                  ? void 0
                  : g.marks.some((E) => E.eq(h.mark));
            this.editor.emit('delete', {
              type: 'mark',
              mark: h.mark,
              from: h.from,
...
var rd = class extends yg {
  ...
  createDoc() {
    let t;
    try {
      t = Hs(this.options.content, this.schema, this.options.parseOptions, {
...
`,
  ...
  get isDestroyed() {
    var t, e;
    return (e = (t = this.editorView) == null ? void 0 : t.isDestroyed) != null
      ? e
      : !0;
  }
  $node(t, e) {
...
function Le(t) {
  return new co({
    ...
    handler: ({ state: e, range: n, match: r }) => {
      let o = U(t.getAttributes, void 0, r);
...
function Xe(t) {
  return new co({
    ...
    handler: ({ state: e, range: n, match: r, chain: o }) => {
      let i = U(t.getAttributes, void 0, r) || {},
...
function Ce(t) {
  return new Dg({
    ...
    handler: ({ state: e, range: n, match: r, pasteEvent: o }) => {
      let i = U(t.getAttributes, void 0, r, o);
...
var se = class t extends R {
  constructor(e) {
    super(e, e);
  }
  map(e, n) {
    let r = e.resolve(n.map(this.head));
    return t.valid(r) ? new t(r) : R.near(r);
  }
  content() {
    return A.empty;
  }
...
var Zs = class t {
  ...
  resolve(e) {
    ...
    return se.valid(n) ? new se(n) : R.near(n);
  }
};
function Yy(t) {
...
function e0(t, e) {
  ...
  return (i.setSelection(O.near(i.doc.resolve(n.pos + 1))), t.dispatch(i), !1);
}
function t0(t) {
  ...
  Xt = class t {
          ...
          (d, f) => {
            ...
            if (o) {
              ...
              (h &&
                ...
                c.push(new Qe(p, void 0, void 0, c.length + u.length))),
                i--,
                p && o.appendMap(p, i));
    ...
    addMaps(e) {
      return this.eventCount == 0
        ? this
        : new t(this.items.append(e.map((n) => new Qe(n))), this.eventCount);
    }
    rebased(e, n) {
      ...
      a =
        ...
        (!s &&
          ...
          (t.prevTime < (n.time || 0) - r.newGroupDelay ||
            !l0(n, t.prevRanges))),
      c = s ? tl(t.prevRanges, n.mapping) : ud(n.mapping.maps);
    return new Ze(
      t.done.addTransform(n, a ? e.selection.getBookmark() : void 0, r, mo(e)),
      Xt.empty,
      c,
      n.time,
      l ?? t.prevComposition
    ...
    new P({
      ...
      props: {
        handleDOMEvents: {
          beforeinput(e, n) {
            let r = n.inputType,
              o = r == 'historyUndo' ? rl : r == 'historyRedo' ? ol : null;
...
var L1 = V.create({
            ...
            decorations: ({ doc: t, selection: e }) => {
              ...
              return (
                t.descendants((a, c) => {
                  ...
                  i.push(
                    Q.node(c, c + a.nodeSize, { class: this.options.className })
                  );
                }),
                Y.create(t, i)
              );
  ...
  md = V.create({
    ...
    extendNodeSchema(t) {
      ...
      return {
        allowGapCursor: (e = U(L(t, 'allowGapCursor', n))) != null ? e : null,
      };
    },
  }),
  il = V.create({
...
var f0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/,
  h0 = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g,
  p0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/,
  m0 = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g,
  g0 = ne.create({
    name: 'bold',
    addOptions() {
      return { HTMLAttributes: {} };
...
`),
                  ...
                  let g =
                      ((s = d[f].match(/^ */)) == null ? void 0 : s[0]) || '',
                    y = Math.min(g.length, this.options.tabSize);
                  if (y === 0) return !0;
                  let b = a;
                  for (let C = 0; C < f; C += 1) b += d[C].length + 1;
                  return (
                    i.delete(b, b + y),
                    l - b <= y && i.setSelection(O.create(i.doc, b)),
                    !0
                  );
                })
              : t.commands.command(({ tr: i }) => {
...
`
                      ...
                      .map((d) => {
                        var f;
                        let h =
                            ((f = d.match(/^ */)) == null ? void 0 : f[0]) ||
                            '',
                          p = Math.min(h.length, this.options.tabSize);
                        return d.slice(p);
                      }).join(`
`);
...
`);
        ...
        ArrowDown: ({ editor: t }) => {
          ...
          return l === void 0
            ...
            : r.nodeAt(l)
              ? t.commands.command(
                  ({ tr: c }) => (c.setSelection(R.near(r.resolve(l))), !0)
                )
              : t.commands.exitCode();
        },
      };
...
`
              ...
              return (
                ...
                s.selection.$from.parent.type !== this.type &&
                  s.setSelection(
                    O.near(s.doc.resolve(Math.max(0, s.selection.from - 2)))
                  ),
                s.setMeta('paste', !0),
                t.dispatch(s),
                !0
      ...
      new P({
        props: {
          handleDrop(e, n) {
            ...
            return (
              t(r, e.posAtCoords({ left: n.clientX, top: n.clientY }).pos),
              !1
            );
          },
        },
...
var yo = (t, e) => e.view.domAtPos(t).node.offsetParent !== null,
  ...
  kd = (t, e) => {
    ...
    if (!u) return !1;
    let d = kn(u.node, (y) => y.type === i.nodes.detailsContent);
              ...
              t.chain()
                .command(({ tr: d }) => {
                  ...
                  return h?.type !== this.type
                    ? !1
                    : (d.setNodeMarkup(f, void 0, { open: !h.attrs.open }), !0);
                })
      ...
      return {
        ...
        unsetDetails:
          ...
          ({ state: t, chain: e }) => {
            ...
            if (!o) return !1;
            let i = kn(o.node, (y) => y.type === r.nodes.detailsSummary),
              s = kn(o.node, (y) => y.type === r.nodes.detailsContent);
      ...
      return [
        new P({
          ...
          appendTransaction: (t, e, n) => {
            ...
            let u = C0(a, (y) => y.type === o, r);
            if (!u) return;
            let d = kn(u.node, (y) => y.type === n.schema.nodes.detailsSummary);
            if (!d.length) return;
            let f = d[0],
              p =
      ...
      return {
        Enter: ({ editor: t }) => {
          ...
          let { tr: S } = e,
            T = o.after(-2);
          S.replaceWith(T, T, C);
          let E = S.doc.resolve(T),
            M = R.near(E, 1);
          S.setSelection(M);
          let I = m,
            v = m + p.nodeSize;
          return (S.delete(I, v), S.scrollIntoView(), n.dispatch(S), !0);
        },
      };
    },
  }),
...
var v0 = H.create({ name: 'doc', topNode: !0, content: 'block+' }),
  Td = v0;
var M0 = H.create({
    name: 'hardBreak',
    addOptions() {
                  ...
                  if (s) {
                    ...
                    if (a.nodeAfter)
                      a.nodeAfter.isTextblock
                        ? i.setSelection(O.create(i.doc, a.pos + 1))
                        : a.nodeAfter.isBlock
                          ? i.setSelection(D.create(i.doc, a.pos))
                          : i.setSelection(O.create(i.doc, a.pos));
                    else {
                      let u =
                        (l = a.parent.type.contentMatch.defaultType) == null
                          ? void 0
                          : l.create();
                      u &&
                        (i.insert(c, u),
                        i.setSelection(O.create(i.doc, c + 1)));
                    }
                    i.scrollIntoView();
                  }
                  return !0;
    ...
    if (
      ...
      if (r)
        if (s.t && typeof s.t == 'string') {
          let a = Object.assign(W0(s.t, r), n);
          Qt(i, a, r);
        } else n && Qt(i, n, r);
      s.t = i;
    }
...
var $ = (t, e, n, r, o) => t.ta(e, n, r, o),
  ee = (t, e, n, r, o) => t.tr(e, n, r, o),
...
function U0(t = []) {
  ...
  (bo == null && (bo = zd(H0)),
    ...
    k(n, '\\', Fo),
    k(n, '\u30FB', jd));
  let r = ee(n, yt, wl, { [fl]: !0 });
  ee(r, yt, r);
  let o = ee(r, gt, _d, { [ir]: !0 }),
    i = ee(r, rr, Wd, { [or]: !0 }),
    s = ee(n, gt, bt, { [hl]: !0 });
  (ee(s, yt, o), ee(s, gt, s), ee(o, yt, o), ee(o, gt, o));
  let l = ee(n, rr, gl, { [pl]: !0 });
  (ee(l, gt),
    ee(l, yt, i),
    ee(l, rr, l),
    ee(i, yt, i),
  ...
  (k(n, ul, u),
    ...
    ee(u, al, u),
    k(u, ul, u));
  let d = ee(n, ll, Kd, { [Vd]: !0 });
  (k(d, '#'), ee(d, ll, d), k(d, j0, d));
  let f = k(d, K0);
  (k(f, '#'), ee(f, ll, d));
  let h = [
      [gt, s],
...
function Jd(t, e) {
  let n = J0(e.replace(/[A-Z]/g, (l) => l.toLowerCase())),
    r = n.length,
    o = [],
    i = 0,
    s = 0;
...
function G0({ groups: t }) {
  ...
  $(f, t.domain, d);
  let h = Be(Fd);
  ($(f, t.tld, h), $(f, t.utld, h), k(c, dr, h));
  let p = k(d, ze);
  (k(p, ze, p), $(p, t.domain, d), $(h, t.domain, d), k(h, et, f), k(h, ze, p));
  let m = k(h, Dt);
  $(m, t.numeric, Fd);
  let g = k(s, ze),
    y = k(s, et);
  (k(g, ze, g), $(g, t.domain, s), $(y, r, i), $(y, t.domain, s));
  let b = Be(wo);
  ($(y, t.tld, b),
    $(y, t.utld, b),
    $(b, t.domain, s),
  ...
  let S = Be(wo),
    T = Be();
  ($(S, e, S), $(S, n, T), $(T, e, S), $(T, n, T), k(b, tt, S), k(C, tt, S));
  let E = k(l, Dt),
    M = k(a, Dt),
    I = k(M, tt),
    v = k(I, tt);
  ...
  return (k(o, dr, b), k(o, Sl, q0), { start: o, tokens: Ud });
}
function Y0(t, e, n) {
  let r = n.length,
    o = 0,
  ...
  for (; o < r; ) {
    ...
    if (f < 0) ((o -= u), o < r && (s.push(n[o]), o++));
      ...
      (s.length > 0 && (i.push(dl($d, e, s)), (s = [])), (o -= f), (u -= f));
      let h = d.t,
        p = n.slice(o - u, o);
      i.push(dl(h, e, p));
    }
...
var X0 = (typeof console < 'u' && console && console.warn) || (() => {}),
  Q0 =
...
function Yo(t) {
  return (X.initialized || Z0(), Y0(X.parser.start, t, Jd(X.scanner.start, t)));
}
Yo.scan = Jd;
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (
        (Us(l).forEach(({ newRange: c }) => {
          ...
          if (d && f) {
            let h = f.split(eb).filter(Boolean);
          ...
          getAttrs: (t) => {
            ...
            return !e ||
              !this.options.isAllowedUri(e, {
                defaultValidate: (n) => !!Zt(n, this.options.protocols),
          ...
          ({ commands: t, chain: e }) =>
            this.options.keepAttributes
              ? e()
                  ...
                  .updateAttributes(ub, this.editor.getAttributes(Xd))
                  .run()
              : t.toggleList(
                  this.name,
                  this.options.itemTypeName,
        ...
        Delete: ({ editor: t }) => {
          ...
          return (
            this.options.listTypes.forEach(({ itemName: n }) => {
              t.state.schema.nodes[n] !== void 0 && Nl(t, n) && (e = !0);
            }),
            e
          );
        },
          ...
          ({ commands: t, chain: e }) =>
            this.options.keepAttributes
              ? e()
                  ...
                  .updateAttributes(pb, this.editor.getAttributes(Zd))
                  .run()
              : t.toggleList(
                  this.name,
                  this.options.itemTypeName,
      ...
      return ({ node: t, HTMLAttributes: e, getPos: n, editor: r }) => {
        let o = document.createElement('li'),
          ...
          c = (u) => {
            ...
            l.ariaLabel =
              ((f =
                (d = this.options.a11y) == null ? void 0 : d.checkboxLabel) ==
              null
                ? void 0
            ...
            (r.isEditable &&
              ...
              r
                ...
                .command(({ tr: f }) => {
                  ...
                  return (
                    f.setNodeMarkup(h, void 0, { ...p?.attrs, checked: d }),
                    !0
                  );
                })
                .run(),
        ...
        handleDrop(s, l) {
          ...
          return (
            a.forEach((u, d) => {
              ...
              e().upload(`componentFileAttachments.${r}.${f}`, u, () => {
                i(f).then((h) => {
                  h &&
                    (t
                      .chain()
          ...
          return a.length
            ? (l.preventDefault(),
              ...
              a.forEach((c, u) => {
                ...
                let d = ('10000000-1000-4000-8000' + -1e11).replace(
                  /[018]/g,
                  (f) =>
                    (
                      f ^
                ...
                e().upload(`componentFileAttachments.${r}.${d}`, c, () => {
                  i(d).then((f) => {
                    f &&
                      (t
                        .chain()
...
function xb(t) {
  ...
  return (
    ...
    x < l.pos && C >= l.pos
      ? { range: { from: x, to: C }, query: g[0].slice(n.length), text: g[0] }
      : null
  );
}
var wb = new z('suggestion');
function Sb({
  pluginKey: t = wb,
  editor: e,
  char: n = '@',
  ...
  let g,
    y = h?.(),
    b = () => {
      let T = e.state.selection.$anchor.pos,
        E = e.view.coordsAtPos(T),
        { top: M, right: I, bottom: v, left: F } = E;
      try {
        return new DOMRect(F, M, I - F, v - M);
      } catch {
        return null;
      }
    },
    x = (T, E) =>
      E
        ? () => {
            let M = t.getState(e.state),
              I = M?.decorationId,
              v = T.dom.querySelector(`[data-decoration-id="${I}"]`);
  ...
  function C(T, E) {
    var M;
    try {
      let v = t.getState(T.state),
        F = v?.decorationId
          ? T.dom.querySelector(`[data-decoration-id="${v.decorationId}"]`)
          : null,
        _ = {
          editor: e,
          ...
          items: [],
          command: (G) =>
            d({ editor: e, range: v?.range || { from: 0, to: 0 }, props: G }),
          decorationNode: F,
          clientRect: x(T, F),
        };
      (M = y?.onExit) == null || M.call(y, _);
    } catch {}
    let I = T.state.tr.setMeta(E, { exit: !0 });
    T.dispatch(I);
  }
  let S = new P({
    key: t,
    view() {
      return {
        update: async (T, E) => {
          var M, I, v, F, _, G, q;
          let B = (M = this.key) == null ? void 0 : M.getState(E),
            j = (I = this.key) == null ? void 0 : I.getState(T.state),
            W = B.active && j.active && B.range.from !== j.range.from,
            ie = !B.active && j.active,
            Te = B.active && !j.active,
            It = !ie && !Te && B.query !== j.query,
            On = ie || (W && It),
            wr = It || W,
            xi = Te || (W && It);
          if (!On && !wr && !xi) return;
          let on = xi && !On ? B : j,
            Zl = T.dom.querySelector(
          ...
          ((g = {
            ...
            text: on.text,
            items: [],
            command: (Hh) => d({ editor: e, range: on.range, props: Hh }),
            decorationNode: Zl,
            clientRect: x(T, Zl),
          }),
            On && ((v = y?.onBeforeStart) == null || v.call(y, g)),
            wr && ((F = y?.onBeforeUpdate) == null || F.call(y, g)),
            (wr || On) && (g.items = await f({ editor: e, query: on.query })),
    ...
    state: {
      ...
      apply(T, E, M, I) {
        ...
        if (((B.composing = F), v && (G || e.view.composing))) {
          ...
          W && p({ editor: e, state: I, range: W.range, isActive: E.active })
            ? ((B.active = !0),
              (B.decorationId = E.decorationId ? E.decorationId : ie),
              (B.range = W.range),
              (B.query = W.query),
              (B.text = W.text))
            : (B.active = !1);
    ...
    props: {
      handleKeyDown(T, E) {
        var M, I, v, F;
        let { active: _, range: G } = S.getState(T.state);
        if (!_) return !1;
        if (E.key === 'Escape' || E.key === 'Esc') {
          let B = S.getState(T.state),
            j = (M = g?.decorationNode) != null ? M : null,
            W =
              j ??
              (B?.decorationId
                ? T.dom.querySelector(
          ...
          if (
            ((I = y?.onKeyDown) == null
              ? void 0
              : I.call(y, { view: T, event: E, range: B.range })) ||
            !1
          )
            return !0;
          let Te = {
            ...
            text: B.text,
            items: [],
            command: (It) => d({ editor: e, range: B.range, props: It }),
            decorationNode: W,
            clientRect: W ? () => W.getBoundingClientRect() || null : null,
          };
          return ((v = y?.onExit) == null || v.call(y, Te), C(T, t), !0);
        }
        return (
          ((F = y?.onKeyDown) == null
            ? void 0
            : F.call(y, { view: T, event: E, range: G })) || !1
        );
      },
      decorations(T) {
        let { active: E, range: M, decorationId: I, query: v } = S.getState(T);
        if (!E) return null;
        let F = !v?.length,
          _ = [a];
        return (
...
var J = class xt extends R {
  ...
  replace(e, n = A.empty) {
    ...
    let i = R.findFrom(e.doc.resolve(e.mapping.slice(r).map(this.to)), -1);
    i && e.setSelection(i);
  }
  replaceWith(e, n) {
...
var tv = Tn('row', { useDeprecatedLogic: !0 }),
  nv = Tn('column', { useDeprecatedLogic: !0 }),
...
function Xb(t) {
  ...
  if (i == 'row')
    for (let a = 0; a < e.childCount; a++) {
      ...
      ((u || d) && (c = Fl(ye(s).row, new A(c, u, d)).content), l.push(c));
    }
  ...
  if (e != o) {
    ...
    for (let s = 0, l = 0; s < o; s++, l++) {
      ...
      for (let u = 0; u < c.childCount; u++) {
        ...
        (s + d.attrs.rowspan > o &&
          (d = d.type.create(
            { ...d.attrs, rowspan: Math.max(1, o - d.attrs.rowspan) },
            d.content
          )),
          a.push(d));
      }
...
function wf(t, e, n, r, o, i, s, l) {
  ...
  for (let c = o; c < i; c++) {
    ...
    if (e.map[u - 1] == d) {
      ...
      (t.setNodeMarkup(p, null, en(f.attrs, s - h, f.attrs.colspan - (s - h))),
        t.insert(p + f.nodeSize, f.type.createAndFill(en(f.attrs, 0, s - h))),
        (c += f.attrs.rowspan - 1));
    }
  }
  return a;
...
function ei(t, e) {
  return (n, r, o) => {
    if (!o) return !1;
    let i = n.selection;
    if (i instanceof J) return ni(n, r, R.near(i.$headCell, e));
    if (t != 'horiz' && !i.empty) return !1;
    let s = Vf(o, t, e);
    if (s == null) return !1;
    if (t == 'horiz') return ni(n, r, R.near(n.doc.resolve(i.head + e), e));
    {
      ...
      return (
        a
          ? (c = R.near(a, 1))
          : e < 0
            ? (c = R.near(n.doc.resolve(l.before(-1)), -1))
            : (c = R.near(n.doc.resolve(l.after(-1)), 1)),
        ni(n, r, c)
      );
    }
  };
...
function rx(t, e, n) {
  ...
  if (o instanceof J) {
    ...
    let i = o.$anchorCell.node(-1),
      ...
      l = te.get(i).rectBetween(o.$anchorCell.pos - s, o.$headCell.pos - s);
    return (
    ...
    let i = oi(t.state),
      s = i.start(-1);
    return (
      Sf(t.state, t.dispatch, s, te.get(i.node(-1)).findCell(i.pos - s), r),
      !0
    );
  } else return !1;
}
...
var Ee = new z('tableColumnResizing');
function _f({
  handleWidth: t = 5,
  cellMinWidth: e = 25,
  ...
  let i = new P({
    ...
    state: {
      init(s, l) {
        ...
        return (r && u && (u[d] = (f, h) => new r(f, n, h)), new sx(-1, !1));
      },
      apply(s, l) {
        return l.apply(s);
      },
...
function fx(t, e, n) {
  ...
  for (let c = 0; c < i.height; c++) {
    ...
    let p = f.colwidth ? f.colwidth.slice() : hx(f.colspan);
...
function Mf(t, e, n, r) {
  let o = t.state.doc.resolve(e),
    i = o.node(-1),
    s = o.start(-1),
    l = te.get(i).colCount(o.pos - s) + o.nodeAfter.attrs.colspan - 1,
...
var ii = ({ editor: t }) => {
    ...
    if (!kx(e)) return !1;
    let n = 0,
      r = Vs(e.ranges[0].$from, (i) => i.type.name === 'table');
    return (
    ...
    addCommands() {
      return {
        ...
        setCellSelection:
          ...
          ({ tr: e, dispatch: n }) => {
            if (n) {
              let r = J.create(e.doc, t.anchorCell, t.headCell);
              e.setSelection(r);
            }
            return !0;
          },
  ...
  Jf = V.create({
    ...
    addExtensions() {
      let t = [];
      return (
        this.options.table !== !1 && t.push(Cx.configure(this.options.table)),
...
var vx = H.create({ name: 'text', group: 'inline' }),
  qf = vx;
var Mx = V.create({
    name: 'textAlign',
    addOptions() {
...
var Jl = ['top', 'right', 'bottom', 'left'],
  Xf = ['start', 'end'],
  ql = Jl.reduce((t, e) => t.concat(e, e + '-' + Xf[0], e + '-' + Xf[1]), []),
  He = Math.min,
  fe = Math.max,
  gr = Math.round;
var We = (t) => ({ x: t, y: t }),
  Ax = { left: 'right', right: 'left', bottom: 'top', top: 'bottom' },
      ...
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          ...
          let {
            ...
            m = d !== void 0 || f === ql ? Ix(d || null, h, f) : f,
            g = await tn(e, p),
          ...
          let E = S.map((v) => {
            ...
            I =
              ((o = E.filter((v) =>
                ...
                : o[0]) || E[0][0];
          return I !== l
            ? { data: { index: y + 1, overflows: S }, reset: { placement: I } }
            : {};
        },
      }
    );
    ...
    return (
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          ...
          if (
            ((v = [...v, { placement: o, overflows: I }]),
            !I.every((q) => q <= 0))
          ) {
            var F, _;
            let q = (((F = i.flip) == null ? void 0 : F.index) || 0) + 1,
              B = E[q];
            if (
              B &&
              (!(d === 'alignment' ? b !== je(B) : !1) ||
                v.every((ie) =>
                  je(ie.placement) === b ? ie.overflows[0] > 0 : !0
                ))
            )
              return {
            ...
            let j =
              (_ = v
                ...
                .sort((W, ie) => W.overflows[1] - ie.overflows[1])[0]) == null
                ? void 0
                : _.placement;
            if (!j)
              switch (h) {
      ...
      async fn(e) {
        ...
        switch (r) {
          case 'referenceHidden': {
            let i = await tn(e, { ...o, elementContext: 'reference' }),
              s = rh(i, n.reference);
            return {
              data: { referenceHiddenOffsets: s, referenceHidden: oh(s) },
            };
          }
          case 'escaped': {
            let i = await tn(e, { ...o, altBoundary: !0 }),
              s = rh(i, n.floating);
        ...
        async fn(e) {
          ...
          function p() {
            ...
            if (d.length >= 2) {
              ...
              let g = Oe(n) === 'left',
                y = fe(...d.map((v) => v.right)),
                b = He(...d.map((v) => v.left)),
                x = d.filter((v) => (g ? v.left === b : v.right === y)),
                C = x[0].top,
    ...
    return (
      t === void 0 && (t = {}),
      {
        ...
        async fn(e) {
          ...
          return {
            ...m,
            data: { x: m.x - n, y: m.y - r, enabled: { [f]: i, [d]: s } },
          };
        },
      }
    );
    ...
    t === void 0 && (t = {}),
    {
      ...
      async fn(e) {
        ...
        let b = m - u.top - u.bottom,
          ...
          M = S;
        if (
          ((n = e.middlewareData.shift) != null && n.enabled.x && (M = x),
          (r = e.middlewareData.shift) != null && r.enabled.y && (E = b),
          T && !f)
        ) {
          let v = fe(u.left, 0),
            F = fe(u.right, 0),
            ...
            G = fe(u.bottom, 0);
          h
            ? (M = p - 2 * (v !== 0 || F !== 0 ? v + F : fe(u.left, u.right)))
            : (E = m - 2 * (_ !== 0 || G !== 0 ? _ + G : fe(u.top, u.bottom)));
        }
        await a({ ...e, availableWidth: M, availableHeight: E });
        let I = await s.getDimensions(l.floating);
        return p !== I.width || m !== I.height ? { reset: { rects: !0 } } : {};
      },
    }
  );
};
...
function ot(t) {
  var e;
  return (e = (gh(t) ? t.ownerDocument : t.document) || window.document) == null
    ? void 0
    : e.documentElement;
}
function gh(t) {
...
function Ke(t) {
  return di() ? t instanceof HTMLElement || t instanceof Me(t).HTMLElement : !1;
}
function mh(t) {
...
var Vx = ['transform', 'translate', 'scale', 'rotate', 'perspective'],
...
var jx = new Set(['html', 'body', '#document']);
function rn(t) {
  return jx.has(nn(t));
}
function Ve(t) {
...
function Gx(t) {
  let e = ot(t),
    ...
    l = -n.scrollTop;
  return (
    Ve(r).direction === 'rtl' && (s += fe(e.clientWidth, r.clientWidth) - o),
  ...
  if (c <= 0) {
    let u = r.ownerDocument,
      ...
      h =
        ...
        0,
      p = Math.abs(r.clientWidth - d.clientWidth - h);
    p <= wh && (i -= p);
  } else c <= wh && (i += c);
  return { width: i, height: s, x: l, y: a };
}
var Xx = new Set(['absolute', 'fixed']);
function Qx(t, e) {
  ...
  for (; $e(s) && !rn(s); ) {
    ...
    (!a && l.position === 'fixed' && (o = null),
      (
        i
          ? !a && !o
          : (!a && l.position === 'static' && !!o && Xx.has(o.position)) ||
            (An(s) && !a && Ah(t, s))
      )
        ? (r = r.filter((u) => u !== s))
        : (o = l),
...
var rw = async function (t) {
  let e = this.getOffsetParent || Eh,
...
var Lh = (t, e) => {
  ...
  Bh = ({ mergeTags: t, noMergeTagSearchResultsMessage: e }) => ({
    items: ({ query: n }) =>
      t.filter((r) =>
  ...
  ...(s.length
    ? [
        uf.configure({
          ...
          suggestion: Bh({ mergeTags: s, noMergeTagSearchResultsMessage: l }),
        }),
      ]
    : []),
  Il,
...
var lw = class {
    constructor({
      ...
      ((this.preventHide = !1),
        ...
        (this.shouldShow = ({ view: c, state: u, from: d, to: f }) => {
          let { doc: h, selection: p } = u,
            { empty: m } = p,
            g = !h.textBetween(d, f).length && ao(u.selection),
            y = this.element.contains(document.activeElement);
          return !(!(c.hasFocus() || y) || m || g || !this.editor.isEditable);
        }),
        ...
        (this.handleDebouncedUpdate = (c, u) => {
          let d = !u?.selection.eq(c.state.selection),
            f = !u?.doc.eq(c.state.doc);
          (!d && !f) ||
    ...
    updatePosition() {
      let { selection: t } = this.editor.state,
        e = $u(this.view, t.from, t.to),
        n = { getBoundingClientRect: () => e, getClientRects: () => [e] };
      if (t instanceof D) {
        let r = this.view.nodeDOM(t.from),
          o = r.dataset.nodeViewWrapper
            ? r
      ...
      if (t instanceof J) {
        let { $anchorCell: r, $headCell: o } = t,
          i = r ? r.pos : o.pos,
          s = o ? o.pos : r.pos,
          l = this.view.nodeDOM(i),
          a = this.view.nodeDOM(s);
        if (!l || !a) return;
        let c =
          l === a
    ...
    show() {
      ...
      this.isVisible ||
        ...
        (e = (t = this.appendTo) != null ? t : this.view.dom.parentElement) ==
          null || e.appendChild(this.element),
    ...
    async init() {
      ((y = new rd({
        ...
        extensions: await zh({
          ...
          insertCustomBlockUsing: (x, C = null) =>
            this.$wire.mountAction(
              'customBlock',
              { id: x, dragPosition: C, mode: 'insert' },
              { schemaComponent: o }
            ),
          key: o,
          mergeTags: u,
        ...
        Object.keys(g).forEach((x) => {
          let C = this.$refs[`floatingToolbar::${x}`];
          if (!C) {
          ...
          y.registerPlugin(
            Ql({
              ...
              shouldShow: ({ editor: S }) => S.isFocused && S.isActive(x),
    ...
    setEditorSelection(b) {
      b &&
        ...
        y
          ...
          .command(
            ({ tr: x }) => (
              x.setSelection(R.fromJSON(y.state.doc, this.editorSelection)),
              !0
            )
          )
          .run());
