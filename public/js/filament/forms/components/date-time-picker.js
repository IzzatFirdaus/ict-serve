      ...
      return function ($) {
        ...
        return (
          (function (b) {
            ...
            if (k !== void 0) {
              var T = b.hours;
              (k ? T < 12 && (b.hours += 12) : T === 12 && (b.hours = 0),
                delete b.afternoon);
            }
          })(H),
          H
          ...
          (H && (W = I[2]),
            ...
            (this.$d = (function (p, M, b, k) {
              try {
                ...
                return Z
                  ? new Date(
                      Date.UTC(ee, fe, X, pe, Le, De, ve + 60 * Z.offset * 1e3)
                    )
                  : b
    ...
    var a = t(n),
      i = {
        ...
        relativeTimeFormatter: function (r, u, d, o) {
          var s = i.words[d];
          if (d.length === 1)
            return d === 'y' && u ? 'jedna godina' : o || u ? s[0] : s[1];
          var _ = i.correctGrammarCase(r, s);
    ...
    return (
      ...
      (t.$set = function (i, e) {
        ...
        if (u === G || u === K) {
          ...
          (_.$d[o](s),
            _.init(),
            (this.$d = _.set(re, Math.min(this.$D, _.daysInMonth())).$d));
        } else o && this.$d[o](s);
        return (this.init(), this);
      }),
      (t.set = function (i, e) {
      ...
      return !!(
        (this.$refs?.disabledDates &&
          JSON.parse(this.$refs.disabledDates.value ?? []).some(
            (s) => ((s = O(s)), s.isValid() ? s.isSame(o, 'day') : !1)
          )) ||
