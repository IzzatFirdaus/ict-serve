    ...
    i === void 0 && (i = {}),
    {
      ...
      async fn(t) {
        ...
        if (
          ...
          var H, G;
          let E = (((H = o.flip) == null ? void 0 : H.index) || 0) + 1,
            J = Y[E];
          if (
            J &&
            (!(h === 'alignment' ? b !== B(J) : !1) ||
              S.every((I) => (B(I.placement) === b ? I.overflows[0] > 0 : !0)))
          )
            return {
...
function k(i) {
  return ct() ? i instanceof HTMLElement || i instanceof A(i).HTMLElement : !1;
}
function kt(i) {
...
function N(i) {
  ...
  let t = i.assignedSlot || i.parentNode || (kt(i) && i.host) || M(i);
...
function _t(i, t) {
  let e = N(i);
  return e === t || !C(e) || K(e) ? !1 : D(e).position === 'fixed' || _t(e, t);
}
function ve(i, t) {
  let e = t.get(i);
  if (e) return e;
...
var ut = class {
  ...
  async getLabelForSingleSelection() {
    ...
    if (
      ...
      F(t) && w(this.initialOptionLabel) && this.state === this.initialState)
    )
  ...
  return {
    ...
    init() {
      (d ||
        ...
        Livewire.hook(
          'commit',
          ({ component: L, commit: S, succeed: H, fail: G, respond: Q }) => {
        ...
        this.$watch('state', async (L) => {
          ...
          this.isLoading = !0;
          let H = await this.$wire.updateTableColumnState(f, v, this.state);
