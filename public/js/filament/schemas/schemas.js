    ...
    (window.Alpine.data('filamentSchema', ({ livewireId: n }) => ({
      handleFormValidationError(e) {
        e.detail.livewireId === n &&
          this.$nextTick(() => {
            ...
            let t = i;
            for (; t; )
              (t.dispatchEvent(new CustomEvent('expand')), (t = t.parentNode));
            setTimeout(
              () =>
                i.closest('[data-field-wrapper]').scrollIntoView({
                  behavior: 'smooth',
                  block: 'start',
                  inline: 'start',
                }),
      ...
      window.Alpine.data(
        ...
        ({ path: n, containerPath: e, isLive: i, $wire: t }) => ({
          ...
          $set: (r, l, a, o = null) => (o ?? (o = i), t.$set(m(e, r, a), l, o)),
          get $state() {
            return t.$get(n);
          },
        })
      ...
      Livewire.hook(
        'commit',
        ({ component: n, commit: e, respond: i, succeed: t, fail: r }) => {
                ...
                window.addEventListener(
                  ...
                  () => {
                    window.dispatchEvent(
                      new CustomEvent(o.name, { detail: o.params })
                    );
                  },
                  { once: !0 }
                );
