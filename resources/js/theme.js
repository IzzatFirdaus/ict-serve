...
document.addEventListener('alpine:init', () => {
    ...
    Alpine.data('themeManager', () => ({
        ...
        updateTheme() {
            const shouldBeDark = this.theme === 'dark' ||
            ...
            if (themeColorMeta) {
                themeColorMeta.setAttribute('content', shouldBeDark ? '#18181B' : '#FFFFFF');
            }
        },
...
function preventFOUC() {
    ...
    const shouldBeDark = theme === 'dark' || ((!theme || theme === 'system') && systemDark);
