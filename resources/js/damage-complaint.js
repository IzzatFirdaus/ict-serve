...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function displayFiles() {
        ...
        selectedFiles.forEach((file, index) => {
            ...
            fileItem.className = 'flex items-center justify-between p-2 bg-bg-gray-50 rounded-[var(--radius-m)]';
    ...
    function getFileIcon(fileType) {
        ...
        if (fileType.startsWith('image/')) {
            pathData = 'M4 3a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2V5a2 2 0 00-2-2H4zm12 12H4l4-8 3 6 2-4 3 6z';
        } else if (fileType === 'application/pdf') {
            pathData = 'M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z';
        } else {
            pathData = 'M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4z';
        }
