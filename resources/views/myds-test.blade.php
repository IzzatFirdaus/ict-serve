    ...
    <div class="min-h-screen">
      ...
      <main class="py-8">
        <x-myds.container variant="wide" centered>
          <x-myds.heading level="1" class="mb-8">
          ...
          <section class="mb-12">
            ...
            <x-myds.text size="lg">
              Large text paragraph with Inter font family.
            </x-myds.text>
            <x-myds.text>
              Default text paragraph with normal sizing.
            </x-myds.text>
          ...
          <section class="mb-12">
            ...
            <div class="flex flex-wrap gap-4 mb-4">
              ...
              <x-myds.button variant="secondary">
                Secondary Button
              </x-myds.button>
          ...
          <section class="mb-12">
            <x-myds.heading level="2" class="mb-6">
              Form Components
            </x-myds.heading>
            <x-myds.grid>
            ...
            <x-myds.grid>
              ...
              <x-myds.grid-item span="4">
                <x-myds.card variant="outlined">
                  ...
                  <x-myds.text>
                    This card has outlined styling with borders.
                  </x-myds.text>
                </x-myds.card>
              </x-myds.grid-item>
            </x-myds.grid>
            ...
            <x-myds.table>
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <x-myds.button size="sm" variant="outline">
                      Edit
                    </x-myds.button>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>User</td>
                  <td>
                    <x-myds.badge variant="warning">Pending</x-myds.badge>
                  </td>
                  <td>
                    <x-myds.button size="sm" variant="outline">
                      Edit
          ...
          <section class="mb-12">
            ...
            <div class="space-y-6">
              {{-- Dropdown Test --}}
              <div>
                <x-myds.text weight="medium" class="mb-2">
                  Dropdown Menu:
                </x-myds.text>
                <x-myds.dropdown label="Actions">
                  <x-myds.dropdown-item href="#" icon="🔍">
                    View Details
                  </x-myds.dropdown-item>
                  <x-myds.dropdown-item href="#" icon="✏️">
                    Edit
                  </x-myds.dropdown-item>
                  <x-myds.dropdown-item href="#" icon="📄">
                    Download
                  </x-myds.dropdown-item>
                  <x-myds.dropdown-item href="#" icon="🗑️" variant="danger">
                    Delete
                  </x-myds.dropdown-item>
                </x-myds.dropdown>
              </div>
              ...
              <div>
                ...
                <x-myds.tooltip
                  message="This is a helpful tooltip with additional information."
                >
              ...
              <div x-data="modal()">
                ...
                <x-myds.modal x-show="open" @click.away="hide()">
                  <x-myds.heading level="3" class="mb-4">
                    Test Modal
                  </x-myds.heading>
                  <x-myds.text class="mb-6">
                    This is a modal dialog for testing purposes.
                  </x-myds.text>
                  <div class="flex justify-end space-x-3">
                    <x-myds.button variant="outline" @click="hide()">
                      Cancel
                    </x-myds.button>
