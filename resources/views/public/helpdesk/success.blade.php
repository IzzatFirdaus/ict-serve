    ...
    <div class="bg-white rounded-lg shadow-lg p-8 text-center">
      ...
      <div class="text-left bg-gray-50 rounded-lg p-6 mb-6">
        ...
        <ol class="space-y-2 text-sm text-gray-700">
          <li class="flex items-start">
            ...
            <span>
              {{ __('You will receive an email confirmation shortly with your ticket details.') }}
            </span>
          </li>
          <li class="flex items-start">
            <span
            ...
            <span>
              {{ __('Our ICT support team will review and prioritize your ticket.') }}
            </span>
          </li>
          <li class="flex items-start">
            <span
            ...
            <span>
              {{ __('A technician will be assigned and will contact you for any additional information needed.') }}
            </span>
          </li>
          <li class="flex items-start">
            <span
            ...
            <span>
              {{ __('You will receive email updates as your ticket progresses through resolution.') }}
            </span>
          </li>
        </ol>
      </div>
      ...
      <x-alert type="info" class="text-left mb-6">
        ...
        <ul class="list-disc list-inside space-y-1 text-sm">
          <li>
            <span class="font-medium text-danger-700">
              {{ __('Urgent:') }}
            </span>
            {{ __('Within 2-4 hours') }}
          </li>
          <li>
            <span class="font-medium text-warning-700">{{ __('High:') }}</span>
            {{ __('Within 8-12 hours') }}
          </li>
          <li>
            <span class="font-medium text-primary-700">
              {{ __('Medium:') }}
            </span>
            {{ __('Within 1-2 business days') }}
          </li>
          <li>
            <span class="font-medium text-gray-700">{{ __('Low:') }}</span>
            {{ __('Within 3-5 business days') }}
          </li>
        </ul>
      </x-alert>
      ...
      <x-alert type="warning" class="text-left mb-6">
        ...
        <ul class="list-disc list-inside space-y-1 text-sm">
          ...
          <li>
            {{ __('You can track your ticket status using the ticket number above') }}
          </li>
          <li>
            {{ __('For urgent issues, our emergency hotline is available 24/7: +60 3-xxxx xxxx') }}
          </li>
          <li>
            {{ __('Do not create duplicate tickets for the same issue') }}
          </li>
        </ul>
      </x-alert>
      ...
      <div class="mt-8 pt-6 border-t border-gray-200">
        ...
        <div class="text-sm text-gray-700 space-y-1">
          ...
          <p>
            ...
            {{ __('ICT Department, Ground Floor, Block A') }}
          </p>
        </div>
      </div>
    </div>
