...
<div class="max-w-2xl mx-auto px-4 py-8">
    <div class="bg-white rounded-lg shadow-lg p-8 text-center">
        ...
        <div class="bg-primary-50 border border-primary-200 rounded-lg p-4 mb-6">
            <p class="text-primary-800 font-medium mb-2">{{ __('Your Request Number:') }}</p>
        ...
        <div class="text-left bg-gray-50 rounded-lg p-6 mb-6">
            ...
            <ol class="space-y-2 text-sm text-gray-700">
                <li class="flex items-start">
                    ...
                    <span>{{ __('You will receive an email confirmation shortly with your request details.') }}</span>
                </li>
                <li class="flex items-start">
                    ...
                    <span>{{ __('Our ICT team will review your request and check equipment availability.') }}</span>
                </li>
                <li class="flex items-start">
                    ...
                    <span>{{ __('You will receive an approval notification via email within 1-2 business days.') }}</span>
                </li>
                <li class="flex items-start">
                    ...
                    <span>{{ __('Once approved, you can collect the equipment from our ICT office.') }}</span>
                </li>
            </ol>
        </div>
        ...
        <x-alert type="info" class="text-left mb-6">
            ...
            <ul class="list-disc list-inside space-y-1 text-sm">
                ...
                <li>{{ __('You can track your request status using the request number above') }}</li>
                <li>{{ __('Contact our ICT team if you have any questions or need to modify your request') }}</li>
            </ul>
        </x-alert>
