...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="font-sans bg-washed text-black min-h-screen flex flex-col">
    ...
    <header class="w-full shadow-card bg-white" role="banner">
      <nav
        class="max-w-[1280px] mx-auto flex items-center justify-between px-6 py-3"
      ...
      >
        ...
        <div class="flex items-center gap-3">
          ...
          <img
            ...
            alt="MOTAC"
            class="h-10 w-auto"
            onerror="this.onerror=null;this.src='https://placehold.co/120x40?text=MOTAC';"
          />
          <span
            class="myds-heading-sm font-semibold text-primary-600 tracking-wide"
            aria-label="ICTServe (iServe)"
          >
            ICTServe
            <span class="sr-only">(iServe)</span>
          </span>
        </div>
        {{-- Navigation links --}}
        <ul class="hidden md:flex gap-6 text-base" aria-label="Main menu">
          <li>
            <a
              href="/"
              class="focus-visible:outline-primary-600 hover:underline underline-offset-4 transition text-txt-black-700"
            >
              Utama
            </a>
          </li>
          ...
          <li>
            <a
              href="/servicedesk"
              class="font-semibold text-primary-600 underline underline-offset-8 pointer-events-none cursor-default"
              aria-current="page"
            >
              ServiceDesk ICT
            </a>
          ...
          <li>
            <a
              href="https://webmail.mygovuc.gov.my"
              target="_blank"
              rel="noopener"
              class="focus-visible:outline-primary-600 hover:underline underline-offset-4 transition text-txt-black-700"
            >
        ...
        <button
          type="button"
          class="ml-4 p-2 rounded-full bg-washed hover:bg-gray-100 focus-visible:outline-2 focus-visible:outline-primary-600"
    ...
    {{-- Banner --}}
    <section
      class="relative w-full bg-gradient-to-r from-primary-100 via-white to-primary-50 shadow-inner"
      aria-label="Page intro"
    >
      <div
        class="max-w-[1280px] mx-auto px-6 py-8 flex flex-col gap-2 md:gap-4"
      >
        ...
        >
          ...
          <svg
            width="300"
            height="100"
            class="absolute right-8 top-6 hidden md:block"
            viewBox="0 0 300 100"
            fill="none"
          >
            <ellipse
            ...
            />
            <path
              d="M225 80 Q220 50 260 40 Q280 35 270 80"
              stroke="#2563EB"
              stroke-width="8"
              stroke-linecap="round"
              fill="none"
        ...
        <div class="relative z-10">
          <h1
            class="myds-heading-lg font-semibold text-txt-black-900 tracking-tight"
          >
            Borang Aduan Kerosakan ICT
          </h1>
          <nav
            class="mt-2 flex flex-wrap items-center text-sm text-txt-black-500"
          ...
          >
            <ol class="inline-flex items-center gap-1" role="list">
              <li>
                <a
                  href="/"
                  class="hover:underline text-primary-600 focus-visible:outline-primary-600"
                >
                  Utama
                </a>
              </li>
              <li aria-hidden="true" class="mx-2 text-gray-400">/</li>
              <li class="text-txt-black-500" aria-current="page">
                ServiceDesk ICT
              </li>
            </ol>
          </nav>
    ...
    <main
      id="main-content"
      class="flex-1 flex justify-center items-start bg-washed py-10 px-2"
    >
      <div
        class="w-full max-w-xl bg-white rounded-lg shadow-card border border-otl-gray-200 p-8 relative"
        aria-labelledby="page-title"
      >
        {{-- Document reference code --}}
        <span
          class="absolute top-6 right-8 myds-body-sm text-txt-black-500 uppercase tracking-wider select-none"
          aria-label="Form reference code"
        >
          PK.(S).MOTAC.07.(L1)
        </span>
        {{-- Form title --}}
        <h2
          id="page-title"
          class="myds-heading-md font-medium text-txt-black-900 mb-6"
        >
          Aduan Kerosakan ICT
        </h2>
        {{-- ICT Damage Complaint Form (MYDS form controls) --}}
        <form
          action="{{ route('public.helpdesk.store') }}"
          method="POST"
        ...
        >
          ...
          <div>
            <label
              for="full_name"
              class="mb-1 myds-body-md font-medium text-txt-black-900 block"
            >
              Nama Penuh
              <span aria-hidden="true" class="text-danger-600">*</span>
            </label>
          ...
          <div>
            ...
            >
              ...
              <option value="Teknologi Maklumat">
          ...
          <div>
            <div class="flex items-start gap-3">
              ...
              <label for="declaration" class="myds-body-sm text-txt-black-900">
                Saya memperakui dan mengesahkan bahawa semua maklumat yang
                diberikan di dalam eBorang Laporan Kerosakan ini adalah benar,
                dan bersetuju menerima perkhidmatan Bahagian Pengurusan Maklumat
                (BPM) berdasarkan Piagam Pelanggan sedia ada.
                <span aria-hidden="true" class="text-danger-600">*</span>
              </label>
            </div>
          </div>
    ...
    <footer
      class="w-full bg-white border-t border-otl-gray-200 shadow-inner mt-auto"
    >
      <div
        class="max-w-[1280px] mx-auto px-6 py-6 flex flex-col md:flex-row items-center justify-between gap-4"
      >
        {{-- BPM logo (left) --}}
        ...
        <div class="text-txt-black-500 text-sm text-center">
          © 2025 Hakcipta Terpelihara Bahagian Pengurusan Maklumat (BPM),
          Kementerian Pelancongan, Seni dan Budaya Malaysia.
        </div>
        {{-- Social icons (right, MYDS style, accessible) --}}
        <div class="flex items-center gap-3">
          <a
            href="https://www.facebook.com/motacmalaysia"
            aria-label="Facebook"
            target="_blank"
            rel="noopener"
            class="p-2 rounded-full hover:bg-primary-50 focus-visible:outline-primary-600 transition"
          >
            ...
            >
              <path
                d="M13.5 2.5h-2A3.5 3.5 0 0 0 8 6v2H6v3h2v6h3v-6h2l1-3h-3V6a1 1 0 0 1 1-1h2V2.5Z"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <a
            href="https://twitter.com/motacmalaysia"
          ...
          >
            ...
            >
              <path
                d="M15.95 5.5H13.5l-3.5 4.25-1.2-1.25-3.25 4.5h2.45l3.5-4.25 1.2 1.25 3.25-4.5ZM4.5 15.5h11"
                stroke="currentColor"
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          >
            ...
            >
              <rect
                ...
                stroke-width="1.5"
              />
              <path d="M9 8.5v3l2.5-1.5L9 8.5Z" fill="currentColor" />
            </svg>
          </a>
        </div>
      </div>
