...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <body class="font-sans bg-washed text-black min-h-screen flex flex-col">
    ...
    <x-myds.skip-link href="#main-content">
    ...
    <x-myds.navbar>
      ...
      <x-myds.navbar-menu>
        ...
        <x-myds.navbar-menu-item href="/informasi">
          Informasi
        </x-myds.navbar-menu-item>
        <x-myds.navbar-menu-item href="/muat-turun">
          Muat Turun
        </x-myds.navbar-menu-item>
        <x-myds.navbar-menu-item href="/direktori">
          Direktori
        </x-myds.navbar-menu-item>
        <x-myds.navbar-menu-item href="/servicedesk" active="true">
          ServiceDesk ICT
        </x-myds.navbar-menu-item>
        <x-myds.navbar-menu-item
        ...
        <x-myds.navbar-menu-item href="/my-integriti">
          MY Integriti
        </x-myds.navbar-menu-item>
      </x-myds.navbar-menu>
    ...
    {{-- Banner & Breadcrumb --}}
    <section
      class="w-full bg-gradient-to-r from-primary-100 via-white to-primary-50 shadow-inner"
    ...
    >
      <x-myds.container class="py-8">
        <x-myds.heading
          level="1"
          size="lg"
          class="font-semibold text-txt-black-900 tracking-tight"
        >
          ...
          <x-myds.grid-item span="4">
            <x-myds.card class="relative p-8">
              ...
              <x-myds.heading
                level="2"
                size="md"
                class="font-medium text-txt-black-900 mb-6"
                id="page-title"
              >
                Aduan Kerosakan ICT
              </x-myds.heading>
    ...
    <x-myds.footer>
      <x-myds.footer-section>
        <x-myds.site-info>
          ...
          />
          <span>
            Bahagian Pengurusan Maklumat (BPM), Kementerian Pelancongan, Seni
            dan Budaya Malaysia.
          </span>
        </x-myds.site-info>
        ...
        <span class="text-txt-black-500 text-sm text-center block mt-4">
