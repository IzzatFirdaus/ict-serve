<x-guest-layout>
  <div class="text-center space-y-6">
    <h1 class="myds-heading-md text-txt-black-900 mb-6">
    ...
    @if (session('status') == 'verification-link-sent')
      <div
        class="mb-4 myds-body-sm text-txt-success p-4 bg-bg-success-50 border border-otl-success-200 rounded-[var(--radius-m)]"
        role="status"
      >
        <svg
    ...
    <div
      class="mt-6 flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 sm:space-x-4"
    >
