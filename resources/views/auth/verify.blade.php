...
@section('content')
  ...
  <div
    id="main-content"
    class="myds-container max-w-lg mx-auto py-12"
    tabindex="-1"
  >
    <div
      class="bg-bg-white-0 border border-otl-gray-200 rounded-lg shadow-context-menu p-8"
    >
      <h1 class="myds-heading-md font-semibold text-txt-black-900 mb-3">
        {{ __('Sahkan E-mel Anda') }}
      </h1>
      @if (session('resent'))
      ...
      <p class="myds-body-sm text-txt-black-700 mb-2">
        {{ __('Sebelum meneruskan, sila semak e-mel anda untuk pautan pengesahan.') }}
      </p>
      <p class="myds-body-sm text-txt-black-700 mb-6">
        {{ __('Jika anda tidak menerima e-mel tersebut, anda boleh memintanya semula melalui butang di bawah.') }}
      </p>
