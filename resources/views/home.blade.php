      ...
      <section class="w-full max-w-lg mx-auto">
        ...
        >
          ...
          <header class="flex items-center gap-3 px-6 py-5 bg-primary-600">
            ...
            >
              <path
                d="M12.354 3.146a.5.5 0 0 0-.708 0l-7 7A.5.5 0 0 0 5 10.5V20a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1v-4h2v4a1 1 0 0 0 1 1h4a1 1 0 0 0 1-1V10.5a.5.5 0 0 0-.146-.354l-7-7zM19 20h-3v-4a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v4H5V10.707l7-7 7 7V20z"
                stroke="currentColor"
                stroke-width="1.5"
              />
            </svg>
          ...
          <div class="px-6 py-8 text-center bg-washed">
            @if (session('status'))
              ...
              <div
                class="inline-flex items-center gap-2 bg-success-100 border border-otl-success-200 rounded-md px-4 py-3 mb-6"
                role="status"
                aria-live="polite"
              >
                <svg
