          ...
          >
              ...
              <td colspan="2" style="padding: 32px 0 12px 0">
                ...
                >
                  ...
                  <span style="font-size: 15px; color: #3f3f46">
                    Thank you for submitting your equipment loan request. Our
                    ICT team is now processing your application.
                  </span>
                </div>
              </td>
            </tr>
              ...
              <td colspan="2" style="padding-top: 24px">
                ...
                >
                  ...
                  <tr>
                    ...
                    <td>
                      {{ $loanRequest->loan_start_date->diffInDays($loanRequest->loan_end_date) }}
                      days
                    </td>
                  </tr>
                  <tr>
              ...
              <td colspan="2" style="padding-top: 28px">
                ...
                >
                  ...
                  <ol style="margin: 8px 0 0 18px; padding: 0; color: #18181b">
                    <li>
                      ICT team will review your request and check equipment
                      availability.
                    </li>
                    <li>
                      You will receive approval notification within 1–2 business
                      days.
                    </li>
            ...
            <tr>
              <td colspan="2" align="center" style="padding-top: 26px">
                <a
                  href="{{ route('public.track') . '?tracking_number=' . $loanRequest->request_number }}"
                  style="
                    background: #2563eb;
                    color: #fff;
                    font-family: Poppins, Arial, sans-serif;
            ...
            <tr>
              <td colspan="2" style="padding-top: 28px">
                ...
                >
                  ...
                  <li>
                    Contact the ICT team if you have any questions or need to
                    modify your request.
                  </li>
                </ul>
              </td>
