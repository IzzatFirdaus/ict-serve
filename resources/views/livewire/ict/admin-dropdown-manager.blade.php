<div class="myds-container max-w-7xl mx-auto py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between mb-4">
            <h1 class="text-heading-l font-semibold text-txt-black-900 dark:text-txt-black-900">
        ...
        <p class="text-body-base text-txt-black-700 dark:text-txt-black-700">
            ...
            All data is stored securely and follows MYDS accessibility standards.
        </p>
    </div>
    ...
    @if($currentCategory)
        <div class="mb-8">
            <x-myds.callout variant="info">
                <h3 class="text-body-sm font-medium text-txt-black-900 dark:text-txt-black-900 mb-1">
        ...
        <div class="flex-1 max-w-md">
            <div class="relative">
                ...
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <svg class="h-5 w-5 text-txt-black-400 dark:text-txt-black-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="myds-card overflow-hidden">
        @if(empty($items))
            <div class="p-12 text-center">
                <svg class="mx-auto h-12 w-12 text-txt-black-400 dark:text-txt-black-400 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <table class="min-w-full" role="table">
                    <thead>
                        <tr class="border-b border-otl-gray-200 dark:border-otl-gray-200">
                            <th class="px-6 py-4 text-left text-body-xs font-medium text-txt-black-500 dark:text-txt-black-500 uppercase tracking-wider">
                                Name
                            </th>
                            <th class="px-6 py-4 text-left text-body-xs font-medium text-txt-black-500 dark:text-txt-black-500 uppercase tracking-wider">
                                Description
                            ...
                            <th class="px-6 py-4 text-right text-body-xs font-medium text-txt-black-500 dark:text-txt-black-500 uppercase tracking-wider">
                                Actions
                            </th>
                        </tr>
                    </thead>
    ...
    <!-- Add/Edit Form Modal -->
    @if($showAddForm)
        <div class="fixed inset-0 bg-gray-600/50 dark:bg-gray-900/50 overflow-y-auto h-full w-full z-50 backdrop-blur-sm"
            ...
            <div class="relative top-20 mx-auto p-0 border-0 max-w-md shadow-context-menu rounded-lg bg-bg-white-0 dark:bg-bg-white-0">
                <div class="p-6">
                            ...
                            <div class="myds-field">
                                ...
                                <div class="flex items-center mt-2" x-data="{ active: @entangle('itemActive') }">
                                    <label class="flex items-center cursor-pointer">
                                        ...
                                        <span class="ml-3 text-body-sm text-txt-black-700 dark:text-txt-black-700">
                ...
                <div class="p-6">
                    <div class="flex items-start space-x-4 mb-6">
                        <div class="flex-shrink-0">
                            <div class="w-10 h-10 bg-danger-50 dark:bg-danger-50 rounded-full flex items-center justify-center">
                        ...
                        <div class="flex-1 min-w-0">
                            ...
                            <p class="text-body-sm text-txt-black-700 dark:text-txt-black-700 leading-relaxed">
