    ...
    <div class="myds-container max-w-4xl mx-auto py-8">
        ...
        <header class="mb-8">
            ...
            <x-myds.callout variant="info">
                <p class="text-body-sm">
                    ...
                    Semua maklumat yang bertanda <span class="text-danger-600 dark:text-danger-400 font-medium">*</span> adalah wajib diisi.
        ...
        <form wire:submit="submit"
            ...
            <x-myds.panel variant="default" x-show="currentStep === 2">
                ...
                <div class="space-y-6">
                    ...
                    @if($showEquipmentSelector)
                        <div class="space-y-4">
                            <h3 class="font-heading text-heading-xs font-medium text-txt-black-900 dark:text-txt-black-900">
                    ...
                    <div>
                        <x-myds.select
                            ...
                            :options="$priorities"
                        />
                        <p class="mt-1 text-body-xs text-txt-black-500 dark:text-txt-black-500">
            ...
            <x-myds.panel variant="warning" x-show="currentStep === 3">
                ...
                <div class="space-y-6">
                    <!-- Declaration -->
                    <div class="bg-bg-white-0 dark:bg-bg-white-0 border border-otl-gray-200 dark:border-otl-gray-200 rounded-radius-m p-6">
                        <h3 class="font-heading text-heading-xs font-medium text-txt-black-900 dark:text-txt-black-900 mb-4">
                            Perakuan Pelapor
                        </h3>
                        <div class="prose prose-sm text-txt-black-700 dark:text-txt-black-700 max-w-none">
                    ...
                    <div class="flex items-start space-x-3 p-4 border border-danger-200 dark:border-danger-200 rounded-radius-m bg-danger-25 dark:bg-danger-25">
                        <input type="checkbox"
                               id="confirmation"
                               wire:model.live="confirmation"
                               class="mt-1 h-4 w-4 text-primary-600 focus:ring-fr-primary border-otl-gray-300 rounded">
                        <label for="confirmation" class="text-body-sm text-txt-black-900 dark:text-txt-black-900 font-medium">
                            Saya mengesahkan bahawa semua maklumat yang diberikan adalah benar dan tepat. *
                        </label>
                    </div>
                    @error('confirmation')
                        <div class="text-danger-600 dark:text-danger-400 text-body-sm mt-1" role="alert">
                            {{ $message }}
                        </div>
                    @enderror
                </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="space-y-2 text-body-sm">
                                ...
                                <div><strong>Keutamaan:</strong>
                                    <x-myds.tag :variant="$priority === 'high' ? 'danger' : ($priority === 'medium' ? 'warning' : 'success')" size="sm">
        ...
        @if(session()->has('success'))
            <div class="fixed inset-0 bg-gray-600/50 dark:bg-gray-900/50 flex items-center justify-center z-50"
                ...
                <div class="bg-bg-white-0 dark:bg-bg-white-0 rounded-radius-l shadow-context-menu p-8 max-w-md mx-4 text-center">
                    ...
                    <p class="text-body-xs text-txt-black-500 dark:text-txt-black-500 mb-6">
