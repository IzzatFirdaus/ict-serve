<div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
    ...
    <div class="mb-4">
        ...
        <select wire:model="reportType" class="w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">
