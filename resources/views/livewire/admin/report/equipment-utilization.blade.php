<div>
    <h3 class="text-lg font-semibold mb-4">{{ __('Equipment Utilization by Category') }}</h3>
        ...
        <tbody>
            @foreach($stats as $row)
                <tr>
                    ...
                    <td class="px-4 py-2 text-center text-success-700 font-bold">{{ $row->available }}</td>
                    <td class="px-4 py-2 text-center text-danger-700 font-bold">{{ $row->loaned }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
