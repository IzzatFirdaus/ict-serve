<div>
    <h3 class="text-lg font-semibold mb-4">{{ __('Helpdesk Performance Metrics') }}</h3>
    <div class="grid grid-cols-2 gap-4 mb-6">
        <div class="bg-warning-50 rounded-lg p-4">
            <div class="text-sm text-gray-600">{{ __('Open') }}</div>
            <div class="text-2xl font-bold text-warning-700">{{ $stats['open'] }}</div>
        </div>
        ...
        <div class="bg-success-50 rounded-lg p-4">
            ...
            <div class="text-2xl font-bold text-success-700">{{ $stats['resolved'] }}</div>
        </div>
