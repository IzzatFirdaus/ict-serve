        ...
        <div class="max-w-4xl mx-auto">
            ...
            <form wire:submit="submit" class="bg-white dark:bg-dialog-active rounded-lg shadow-sm border border-divider">
                ...
                <div class="px-6 py-6 space-y-6">
                    <!-- Purpose -->
                    <div>
                        <label for="purpose" class="font-inter text-xs font-medium text-black-700 dark:text-black-300 block mb-2">
                            Tujuan Pinjaman <span class="text-danger-600">*</span>
                        </label>
                        <x-myds.input
                            type="text"
                            id="purpose"
                    ...
                    <div>
                        <label for="location" class="font-inter text-xs font-medium text-black-700 dark:text-black-300 block mb-2">
                            Lokasi Penggunaan <span class="text-danger-600">*</span>
                        </label>
                        <x-myds.input
                            type="text"
                            id="location"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label for="start_date" class="font-inter text-xs font-medium text-black-700 dark:text-black-300 block mb-2">
                                Tarikh Mula <span class="text-danger-600">*</span>
                            </label>
                            <x-myds.input
                                type="date"
                                id="start_date"
                        ...
                        <div>
                            <label for="end_date" class="font-inter text-xs font-medium text-black-700 dark:text-black-300 block mb-2">
                                Tarikh Tamat <span class="text-danger-600">*</span>
                            </label>
                            <x-myds.input
                                type="date"
                                id="end_date"
                    ...
                    <div>
                        <label class="font-inter text-xs font-medium text-black-700 dark:text-black-300 block mb-2">
                            Peralatan yang Diperlukan <span class="text-danger-600">*</span>
                        </label>
                        <div class="border border-divider rounded-lg p-4">
                                    ...
                                    @foreach($available_equipment_items as $item)
                                        <div class="flex items-center space-x-3">
                                            <x-myds.checkbox
                                                ...
                                                value="{{ $item['id'] }}"
                                            />
                                            <label for="equipment_{{ $item['id'] }}" class="font-inter text-sm text-black-700 dark:text-black-300 cursor-pointer">
                                                {{ $item['name'] }}
                                                <span class="text-black-500 dark:text-black-400 text-xs block">
                                                    {{ ucfirst($item['type']) }}
                                                </span>
                                            </label>
                                        </div>
                            ...
                            @else
                                <p class="font-inter text-sm text-black-500 dark:text-black-400 text-center py-4">
                    ...
                    <!-- Notes -->
                    <div>
                        <label for="notes" class="font-inter text-xs font-medium text-black-700 dark:text-black-300 block mb-2">
                            Catatan Tambahan
                        </label>
                        <textarea
                            id="notes"
                    ...
                    <div>
                        <div class="flex items-start space-x-3">
                            <x-myds.checkbox
                                ...
                                class="mt-1"
                            />
                            <label for="terms_accepted" class="font-inter text-sm text-black-700 dark:text-black-300 cursor-pointer">
                                Saya mengakui bahawa saya telah membaca dan memahami
                                <a href="#" class="text-primary-600 hover:text-primary-700 underline">terma dan syarat</a>
