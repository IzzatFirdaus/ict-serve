                        ...
                        <table class="min-w-full border border-otl-gray-200 dark:border-otl-gray-200 rounded-radius-m">
                            <thead>
                                <tr class="bg-bg-washed dark:bg-bg-washed">
                                    <th class="px-4 py-3 text-left text-body-xs font-medium text-txt-black-900 dark:text-txt-black-900">
                                        Bil.
                                    </th>
                                    <th class="px-4 py-3 text-left text-body-xs font-medium text-txt-black-900 dark:text-txt-black-900">
                                        Jenis Peralatan *
                                    ...
                                    <th class="px-4 py-3 text-center text-body-xs font-medium text-txt-black-900 dark:text-txt-black-900">
                                        Tindakan
                                    </th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-otl-gray-200 dark:divide-otl-gray-200">
                                @foreach($equipmentRequests as $index => $request)
                                    <tr class="hover:bg-bg-white-50 dark:hover:bg-bg-white-50 transition-colors">
                                        <td class="px-4 py-3 text-body-sm text-txt-black-900 dark:text-txt-black-900">
                                            {{ $index + 1 }}
                                        </td>
                                        <td class="px-4 py-3">
