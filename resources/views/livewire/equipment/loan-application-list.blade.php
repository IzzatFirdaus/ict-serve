            ...
            <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                    <h1 class="font-poppins text-2xl font-semibold text-black-900 dark:text-white">
                        Senarai Permohonan Pinjaman Peralatan
                    </h1>
                    <p class="font-inter text-sm text-black-500 dark:text-black-400 mt-2">
                        Lihat dan urus permohonan pinjaman peralatan ICT anda
                    </p>
                </div>
                <div class="mt-4 md:mt-0">
                    <x-myds.button variant="primary" class="w-full md:w-auto" onclick="window.location.href='{{ route('loan.application.create') }}'">
                        <!-- Plus Icon SVG -->
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8">
            ...
            <div class="bg-white dark:bg-dialog border border-divider rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="font-inter text-xs font-medium text-black-500 dark:text-black-400">Tertunda</p>
                        <p class="font-poppins text-xl font-semibold text-black-900 dark:text-white">{{ $counts['pending'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-dialog border border-divider rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="font-inter text-xs font-medium text-black-500 dark:text-black-400">Diluluskan</p>
                        <p class="font-poppins text-xl font-semibold text-black-900 dark:text-white">{{ $counts['approved'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-dialog border border-divider rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        <p class="font-inter text-xs font-medium text-black-500 dark:text-black-400">Ditolak</p>
                        <p class="font-poppins text-xl font-semibold text-black-900 dark:text-white">{{ $counts['rejected'] }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-dialog border border-divider rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="font-poppins text-xl font-semibold text-black-900 dark:text-white">{{ $counts['completed'] }}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-dialog border border-divider rounded-lg overflow-hidden">
                        ...
                        <thead class="bg-washed dark:bg-black-100">
                            <tr>
                                <th class="px-6 py-3 text-left">
                                    <button wire:click="sortBy('loan_number')" class="flex items-center space-x-1 hover:text-primary-600 dark:hover:text-primary-400">
                                ...
                                <th class="px-6 py-3 text-left">
                                    <button wire:click="sortBy('purpose')" class="flex items-center space-x-1 hover:text-primary-600 dark:hover:text-primary-400">
                                        <span class="font-inter text-xs font-medium text-black-700 dark:text-black-300 uppercase tracking-wider">
                                            Tujuan
                                        </span>
                            ...
                            @foreach($applications as $application)
                                <tr class="hover:bg-washed dark:hover:bg-black-100">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <div class="font-inter text-sm text-black-500 dark:text-black-400">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <div class="font-inter text-xs text-black-500 dark:text-black-400">
            ...
            @else
                ...
                <div class="text-center py-12">
                    ...
                    <x-myds.button variant="primary" onclick="window.location.href='{{ route('loan.application.create') }}'">
                        <!-- Plus Icon SVG -->
                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"/>
                        </svg>
