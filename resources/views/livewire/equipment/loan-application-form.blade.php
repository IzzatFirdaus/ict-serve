<div class="max-w-6xl mx-auto py-8">
    ...
    <form wire:submit="submit"
        ...
        <section class="bg-white rounded-lg border border-divider p-6" aria-labelledby="applicant-info-heading">
            <h2 id="applicant-info-heading" class="font-poppins text-lg font-medium text-black-900 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Applicant Division -->
                <div>
                    <x-myds.label for="applicant_division" required>Bahagian</x-myds.label>
                    <x-myds.select 
                ...
                <!-- Applicant Email -->
                <div>
                    <x-myds.label for="applicant_email" required>Alamat E-mel</x-myds.label>
                    <x-myds.input 
                        type="email"
                        id="applicant_email"
                ...
                <!-- Applicant Phone -->
                <div>
                    <x-myds.label for="applicant_phone" required>Nombor Telefon</x-myds.label>
                    <x-myds.input 
                        type="tel"
                        id="applicant_phone"
        ...
        <section class="bg-white rounded-lg border border-divider p-6" aria-labelledby="officer-info-heading">
            <h2 id="officer-info-heading" class="font-poppins text-lg font-medium text-black-900 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Officer Phone -->
                <div>
                    <x-myds.label for="officer_phone" required>Nombor Telefon</x-myds.label>
                    <x-myds.input 
                        type="tel"
                        id="officer_phone"
        ...
        <section class="bg-white rounded-lg border border-divider p-6" aria-labelledby="equipment-info-heading">
            <h2 id="equipment-info-heading" class="font-poppins text-lg font-medium text-black-900 mb-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <!-- Start Date -->
                <div>
                    <x-myds.label for="loan_start_date" required>Tarikh Mula Pinjaman</x-myds.label>
                    <x-myds.input 
                        type="date"
                        id="loan_start_date"
                ...
                <!-- End Date -->
                <div>
                    <x-myds.label for="loan_end_date" required>Tarikh Tamat Pinjaman</x-myds.label>
                    <x-myds.input 
                        type="date"
                        id="loan_end_date"
                ...
                <div class="md:col-span-2">
                    <x-myds.label for="loan_purpose" required>Tujuan Pinjaman</x-myds.label>
                    <x-myds.textarea 
                        id="loan_purpose"
                    ...
                    @foreach($this->equipmentRequests as $index => $request)
                        <div class="border border-divider rounded-lg p-4"
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <!-- Equipment Selection -->
                                <div>
                                    <x-myds.label for="equipment_requests.{{ $index }}.equipment_id" required>Pilih Peralatan</x-myds.label>
                                    <x-myds.select 
                                    ...
                                    <x-myds.error field="equipment_requests.{{ $index }}.equipment_id" />
                                </div>

                                <!-- Quantity -->
                                <div>
                                    <x-myds.label for="equipment_requests.{{ $index }}.quantity" required>Kuantiti</x-myds.label>
                                    <x-myds.input 
                                        type="number"
                                        ...
                                        max="10"
                                        required />
                                    <x-myds.error field="equipment_requests.{{ $index }}.quantity" />
                                </div>

                                <!-- Remarks -->
                                <div>
                                    <x-myds.label for="equipment_requests.{{ $index }}.remarks">Catatan</x-myds.label>
                                    <x-myds.input 
                                        type="text"
        ...
        <!-- Part 4: Declaration -->
        <section class="bg-white rounded-lg border border-divider p-6" aria-labelledby="declaration-heading">
            <h2 id="declaration-heading" class="font-poppins text-lg font-medium text-black-900 mb-6">
                Bahagian 4: Perakuan
            </h2>

            <div>
                <div class="bg-washed p-4 rounded-lg border-l-4 border-primary-600 mb-4">
                    <p class="font-inter text-sm text-black-700 mb-3">
                        <strong>Saya dengan ini mengaku dan mengesahkan bahawa:</strong>
                    </p>
                    <ol class="list-decimal list-inside space-y-2 ml-4 font-inter text-sm text-black-700 leading-relaxed">
        ...
        <!-- Form Actions -->
        <div class="flex flex-col sm:flex-row gap-4 justify-end pt-6 border-t border-divider">
            <x-myds.button 
                type="button"
                variant="secondary"
    ...
    <div class="mt-8 text-center">
        <div class="flex items-center justify-center space-x-2 font-inter text-sm text-black-500">
