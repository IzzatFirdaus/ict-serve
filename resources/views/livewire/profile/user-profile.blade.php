<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="text-center mb-6">
                        <div class="relative mx-auto w-24 h-24 mb-4">
                            ...
                            @else
                                <div class="w-24 h-24 rounded-full bg-gray-300 dark:bg-gray-600 flex items-center justify-center border-4 border-white dark:border-gray-700 shadow-lg">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ $staff_id }}</p>
                        <p class="text-xs text-gray-400 dark:text-gray-500">{{ $department }}</p>
                    </div>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                        <h4 class="text-sm font-medium text-gray-900 dark:text-white mb-4">Statistik / Statistics</h4>

                        <div class="space-y-3">
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">Jumlah Tiket / Total Tickets</span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $userStats['total_tickets'] ?? 0 }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">Tiket Selesai / Resolved</span>
                                <span class="font-medium text-green-600">{{ $userStats['resolved_tickets'] ?? 0 }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">Pinjaman Aktif / Active Loans</span>
                                <span class="font-medium text-blue-600">{{ $userStats['active_loans'] ?? 0 }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500 dark:text-gray-400">Jumlah Pinjaman / Total Loans</span>
                                <span class="font-medium text-gray-900 dark:text-white">{{ $userStats['total_loans'] ?? 0 }}</span>
                            </div>
                        </div>
            ...
            <div class="lg:col-span-3 space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Kemaskini maklumat peribadi anda / Update your personal information
                        </p>
                    </div>
                    <form wire:submit="updateProfile" class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" wire:model="staff_id" id="staff_id"
                                       class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                                @error('staff_id')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="flex justify-end">
                            <button type="submit"
                                ...
                                <svg wire:loading wire:target="updateProfile" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Kemaskini kata laluan untuk keselamatan yang lebih baik / Update your password for better security
                        </p>
                    </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Tetapkan keutamaan aplikasi anda / Set your application preferences
                        </p>
                    </div>
                    <form wire:submit="updatePreferences" class="p-6 space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <!-- Language Preference -->
                            <div>
                                <label for="preferred_language" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                            ...
                            <div>
                                ...
                                <select wire:model="theme_preference" id="theme_preference"
                                        class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:ring-indigo-500 focus:border-indigo-500">
                        ...
                        <div class="border-t border-gray-200 dark:border-gray-700 pt-6">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center">
                                    <input type="checkbox" wire:model="email_notifications" id="email_notifications"
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" wire:model="sms_notifications" id="sms_notifications"
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 rounded">
                                    <label for="sms_notifications" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                        Notifikasi SMS / SMS Notifications
                                    </label>
                                </div>

                                <div class="flex items-center">
                                    <input type="checkbox" wire:model="browser_notifications" id="browser_notifications"
                                           class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 rounded">
                                    <label for="browser_notifications" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                            ...
                            <div class="mt-6">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div class="flex items-center">
                                        <input type="checkbox" wire:model="notification_types.ticket_updates" id="ticket_updates"
                                               class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="ticket_updates" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                            Kemaskini Tiket / Ticket Updates
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input type="checkbox" wire:model="notification_types.loan_approvals" id="loan_approvals"
                                               class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="loan_approvals" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                            Kelulusan Pinjaman / Loan Approvals
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input type="checkbox" wire:model="notification_types.equipment_reminders" id="equipment_reminders"
                                               class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="equipment_reminders" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                                            Peringatan Peralatan / Equipment Reminders
                                        </label>
                                    </div>

                                    <div class="flex items-center">
                                        <input type="checkbox" wire:model="notification_types.system_announcements" id="system_announcements"
                                               class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 dark:border-gray-600 rounded">
                                        <label for="system_announcements" class="ml-3 text-sm text-gray-700 dark:text-gray-300">
                        ...
                        <div class="flex justify-end">
                            <button type="submit"
                                ...
                                <svg wire:loading wire:target="updatePreferences" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none" viewBox="0 0 24 24">
                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                                </svg>
                ...
                <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            Aktiviti terkini anda dalam sistem / Your recent activity in the system
                        </p>
                    </div>
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <div class="flex items-start space-x-3">
                                <div class="flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center
                                    {{ $activity['type'] === 'ticket' ? 'bg-blue-100 text-blue-600' : 'bg-green-100 text-green-600' }}">
    ...
    <script src="{{ asset('js/livewire/profile-user-profile.js') }}" defer></script>
</div>
