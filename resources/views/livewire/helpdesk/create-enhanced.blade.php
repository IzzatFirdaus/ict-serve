    ...
    <div class="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                ...
                <div class="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1">
                    <button type="button"
                            ...
                            class="px-4 py-2 rounded-md text-sm font-medium transition-colors
                                   {{ $ticketType === 'general' ? 'bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                        Umum / General
                    </button>
                    <button type="button"
                            wire:click="$set('ticketType', 'incident')"
                            class="px-4 py-2 rounded-md text-sm font-medium transition-colors
                                   {{ $ticketType === 'incident' ? 'bg-white dark:bg-gray-800 text-red-600 dark:text-red-400 shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                        Insiden / Incident
                    </button>
                    <button type="button"
                            wire:click="$set('ticketType', 'damage')"
                            class="px-4 py-2 rounded-md text-sm font-medium transition-colors
                                   {{ $ticketType === 'damage' ? 'bg-white dark:bg-gray-800 text-orange-600 dark:text-orange-400 shadow-sm' : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white' }}">
                        Kerosakan / Damage
                    </button>
                </div>
            </div>
            ...
            <div class="flex justify-between mt-3">
                <span class="text-xs {{ $currentStep >= 1 ? 'text-blue-600 dark:text-blue-400 font-medium' : 'text-gray-400' }}">
                    Jenis & Tajuk / Type & Title
                </span>
                <span class="text-xs {{ $currentStep >= 2 ? 'text-blue-600 dark:text-blue-400 font-medium' : 'text-gray-400' }}">
                    Butiran / Details
                </span>
                <span class="text-xs {{ $currentStep >= 3 ? 'text-blue-600 dark:text-blue-400 font-medium' : 'text-gray-400' }}">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
            <form wire:submit="submit">
                            ...
                            <div>
                                ...
                                <div class="mb-6">
                                    <label for="title" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Tajuk / Title <span class="text-red-500">*</span>
                                    </label>
                                    <input type="text"
                                ...
                                <div>
                                    <label for="category_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Kategori / Category <span class="text-red-500">*</span>
                                    </label>
                        ...
                        <div class="space-y-6" wire:key="step2">
                            ...
                            <div>
                                ...
                                <textarea wire:model.live="description"
                                          ...
                                          rows="4"
                                          class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white"
                                          placeholder="Huraikan masalah dengan terperinci / Describe the issue in detail"></textarea>
                                @error('description')
                                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="priority" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Keutamaan / Priority <span class="text-red-500">*</span>
                                    </label>
                                ...
                                <div>
                                    <label for="urgency" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Kesegeraan / Urgency <span class="text-red-500">*</span>
                                    </label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label for="location" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Lokasi / Location <span class="text-red-500">*</span>
                                    </label>
                                    <input type="text"
                                ...
                                <div>
                                    <label for="contact_phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Nombor Telefon / Phone Number <span class="text-red-500">*</span>
                                    </label>
                                    <input type="tel"
                    ...
                    @if($currentStep === 3)
                        <div class="space-y-6" wire:key="step3">
                            ...
                            @if($showEquipmentSelector)
                                <div>
                                    <label for="equipment_item_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                        Item Peralatan / Equipment Item
                                    </label>
                                    <select wire:model.live="equipment_item_id"
                                            id="equipment_item_id"
                                            class="block w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                                        <option value="">Pilih item peralatan / Select equipment item</option>
                                        @foreach($equipmentItems as $item)
                                            <option value="{{ $item['id'] }}">
                                                {{ $item['brand'] }} {{ $item['model'] }}
                                                @if(isset($item['category']['name'])) - {{ $item['category']['name'] }}@endif
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                                    ...
                                    <span class="text-gray-500 text-xs">(Maks 5 fail, 10MB setiap satu / Max 5 files, 10MB each)</span>
                                </label>
                                ...
                                <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 hover:border-blue-400 dark:hover:border-blue-500 transition-colors">
                                    <input type="file"
                                           ...
                                           class="hidden">
                                    <label for="attachments" class="cursor-pointer block text-center">
                                        ...
                                        <p class="text-gray-500 text-sm mt-1">
                                            atau seret dan lepas fail di sini / or drag and drop files here
                                        </p>
                                    </label>
                                </div>
                ...
                <!-- Navigation Buttons -->
                <div class="bg-gray-50 dark:bg-gray-700 px-8 py-6 border-t border-gray-200 dark:border-gray-600 rounded-b-xl">
