...
>
  <h3
    class="text-lg font-semibold text-red-900 dark:text-red-100 mb-4 flex items-center"
  >
    <svg
      class="w-5 h-5 mr-2"
      fill="none"
  ...
  <div class="mt-6">
    ...
    <div class="flex justify-between mt-1">
      ...
      @enderror
      <span class="text-xs text-gray-500">
        {{ strlen($immediate_action_taken) }}/500
      </span>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
    ...
    <div>
      <label
        for="incident_witnesses"
        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"
      >
        Saksi / Witnesses
        <span class="text-gray-500">(Pilihan / Optional)</span>
      </label>
      <textarea
    ...
    <div>
      <label
        for="incident_location_details"
        class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2"
      >
        Butiran Lokasi / Location Details
        <span class="text-gray-500">(Pilihan / Optional)</span>
      </label>
      <textarea
