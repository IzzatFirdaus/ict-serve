            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Pantau prestasi SLA untuk tiket helpdesk / Monitor SLA performance for helpdesk tickets
                    </p>
                </div>
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="flex items-baseline">
                                    ...
                                    <span class="ml-2 text-sm font-medium text-red-600 dark:text-red-400">
            ...
            <div class="p-6">
                <div class="relative pt-1">
                    <div class="flex mb-2 items-center justify-between">
                        <div>
                            <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-green-600 dark:text-green-400 bg-green-200 dark:bg-green-800">
                                SLA Met
                            </span>
                        </div>
                    ...
                    <div class="overflow-hidden h-4 mb-4 text-xs flex rounded bg-green-200 dark:bg-green-800">
                        <div style="width:{{ $slaMetrics['met_percentage'] }}%"
                ...
                <div class="relative pt-1">
                    <div class="flex mb-2 items-center justify-between">
                        <div>
                            <span class="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-red-600 dark:text-red-400 bg-red-200 dark:bg-red-800">
                                SLA Breached
                            </span>
                        </div>
                        <div class="text-right">
                            <span class="text-xs font-semibold inline-block text-red-600 dark:text-red-400">
                                {{ $slaMetrics['breached_percentage'] }}%
                            </span>
                        </div>
                    </div>
                    <div class="overflow-hidden h-4 mb-4 text-xs flex rounded bg-red-200 dark:bg-red-800">
                        <div style="width:{{ $slaMetrics['breached_percentage'] }}%"
                                ...
                                <div class="flex items-center">
                                    <div class="flex-1 bg-gray-200 dark:bg-gray-600 rounded-full h-2 mr-2">
                                        <div class="bg-green-500 h-2 rounded-full"
                                             style="width: {{ $category['met_percentage'] }}%"></div>
                                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Tiket yang akan melanggar SLA dalam 24 jam / Tickets due to breach SLA within 24 hours
                    </p>
                </div>
                <div class="divide-y divide-gray-200 dark:divide-gray-700 max-h-96 overflow-y-auto">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium
                                        @if($ticket['risk_level'] === 'critical') bg-red-100 text-red-800 dark:bg-red-800 dark:text-red-200
                                ...
                                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    ...
                                    @if($ticket['assigned_to'])
                                        <span class="mx-2">•</span>
                                        <span>Ditugaskan kepada / Assigned to: {{ $ticket['assigned_to'] }}</span>
                                    @endif
                                </div>
                                <div class="mt-2 text-xs">
                                    <span class="text-yellow-600 dark:text-yellow-400 font-medium">
                                        {{ $ticket['time_remaining']['value'] }} {{ $ticket['time_remaining']['unit'] }} / {{ $ticket['time_remaining']['unit_en'] }} tersisa/remaining
                                    </span>
                                </div>
                            </div>
                            <div class="ml-4 flex-shrink-0">
                                <button wire:click="escalateAtRiskTicket({{ $ticket['id'] }})"
                    ...
                    <div class="p-6 text-center text-gray-500 dark:text-gray-400">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            Semua tiket dalam jadual yang selamat / All tickets are on safe schedule
                        </p>
                    </div>
                    @endforelse
                </div>
                            ...
                            <div class="flex-1 min-w-0">
                                ...
                                <div class="mt-2 text-xs">
                                    <span class="text-red-600 dark:text-red-400 font-medium">
                                        Dilanggar sebanyak / Breached by: {{ $ticket['breach_duration']['value'] }} {{ $ticket['breach_duration']['unit'] }} / {{ $ticket['breach_duration']['unit_en'] }}
                                    </span>
                                </div>
                                <div class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                    Tarikh akhir / Due: {{ $ticket['due_at']->format('d/m/Y H:i') }}
                                    @if($ticket['resolved_at'])
                                        <span class="mx-2">•</span>
                                        Selesai / Resolved: {{ $ticket['resolved_at']->format('d/m/Y H:i') }}
                                    @endif
                                </div>
                            </div>
                        </div>
