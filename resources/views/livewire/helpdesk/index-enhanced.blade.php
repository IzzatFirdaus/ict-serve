        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <div class="flex items-center space-x-3">
                    <a href="{{ route('helpdesk.sla-tracker') }}"
            ...
            <div class="p-6">
                ...
                <div class="flex items-center justify-between">
                    <button wire:click="toggleAdvancedFilters"
                        ...
                        <svg class="w-4 h-4 mr-2 transform transition-transform {{ $showAdvancedFilters ? 'rotate-180' : '' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center space-x-2">
                        <label class="text-sm font-medium text-gray-700 dark:text-gray-300">Paparan / View:</label>
