<div class="min-h-screen bg-background-light">
    <div class="max-w-4xl mx-auto px-4 py-8">
        ...
        <!-- Ticket Form -->
        <form wire:submit="submit" class="bg-white rounded-lg shadow-sm border border-divider">
            <!-- Form Header -->
            ...
            <div class="px-6 py-6 space-y-6">
                ...
                <!-- Description -->
                <div>
                    <x-myds.label for="description" required>Huraian Terperinci</x-myds.label>
                    <x-myds.textarea
                        id="description"
                ...
                @if(!empty($equipmentItems))
                    <div>
                        <x-myds.label for="equipment_item_id">Peralatan Berkaitan (Pilihan)</x-myds.label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Contact Phone -->
                    <div>
                        <x-myds.label for="contact_phone" required>Nombor Telefon</x-myds.label>
                        <x-myds.input
                            type="tel"
                            id="contact_phone"
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-divider rounded-lg p-6 text-center hover:border-primary-300 transition-colors">
                        ...
                        <label for="attachments" class="cursor-pointer">
                            <svg class="w-8 h-8 text-black-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if($attachments)
                        <div class="mt-4 space-y-2">
                            @foreach($attachments as $index => $attachment)
                                <div class="flex items-center justify-between bg-washed p-3 rounded-lg">
                                    <div class="flex items-center space-x-3">
                                        <svg class="w-4 h-4 text-black-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Form Actions -->
            <div class="px-6 py-4 border-t border-divider bg-washed rounded-b-lg flex justify-end space-x-4">
