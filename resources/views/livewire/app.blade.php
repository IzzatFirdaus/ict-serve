...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <title>
      {{ config('app.name', 'ICT Serve') }} - Sistem Perkhidmatan ICT MOTAC
    </title>
    ...
    <meta
      name="description"
      content="Sistem Perkhidmatan ICT MOTAC - Platform bersepadu untuk peminjaman peralatan ICT dan pengurusan helpdesk"
    />
    <meta
      name="keywords"
      content="MOTAC, ICT, peminjaman, helpdesk, peralatan, teknologi"
    />
    ...
    <meta
      ...
      content="Sistem Perkhidmatan ICT MOTAC yang mengikuti garis panduan MyGOVEA"
    />
