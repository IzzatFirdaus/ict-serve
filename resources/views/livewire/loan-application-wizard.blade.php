    ...
    <div class="myds-container py-8">
      <div class="myds-grid-12">
        <div class="col-span-full">
          ...
          <p class="text-txt-black-600 mb-3">
  ...
  <div class="myds-container py-12">
    <div class="myds-grid-12">
      <div class="col-span-full lg:col-span-10 lg:col-start-2">
        ...
        <div class="mb-8">
          <div
            class="bg-white rounded-[var(--radius-xl)] border border-otl-gray-200 shadow-md p-6"
          >
            <h2 class="myds-heading-2xs text-txt-black-900 mb-4">
              {{ __('forms.progress.step_of', ['current' => $currentStep, 'total' => $totalSteps]) }}
            </h2>
            ...
            <div class="mb-6">
              <div class="flex justify-between text-xs text-txt-black-500 mb-2">
                ...
                <span>
                  {{ __('forms.progress.percent_complete', ['percent' => round(($currentStep / $totalSteps) * 100)]) }}
                </span>
              </div>
              <div class="w-full bg-gray-200 rounded-full h-2">
                <div
                  class="bg-bg-primary-600 h-2 rounded-full transition-all duration-300"
            ...
            <!-- Step Navigation -->
            <div
              class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-2 text-xs"
            >
                  ...
                  class="p-2 rounded-[var(--radius-s)] text-center transition-colors {{
                    $i == $currentStep
                      ...
                      : ($i < $currentStep
                        ...
                        : 'bg-gray-100 text-txt-black-500')
        ...
        @if (session('error'))
          <div
            class="mb-6 p-4 bg-danger-50 border border-otl-danger-200 rounded-[var(--radius-m)]"
          >
            <div class="flex">
              <x-icon
                name="exclamation-circle"
                class="w-5 h-5 text-txt-danger mt-0.5 mr-3"
              />
              <div>
                <h4 class="text-sm font-semibold text-txt-danger mb-1">
                  {{ __('alerts.error') }}
                </h4>
        ...
        >
          ...
          @if ($currentStep == 1)
            <h2
              class="myds-heading-xs text-txt-black-900 mb-6 pb-3 border-b border-otl-divider"
            >
          ...
          @if ($currentStep == 2)
            ...
            @if (! $same_as_applicant)
              <div
                class="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-50 rounded-[var(--radius-m)]"
              >
                <x-myds.form.input
                  :label="__('forms.labels.full_name')"
            ...
            @else
              <div
                class="p-4 bg-success-50 border border-otl-success-200 rounded-[var(--radius-m)]"
              >
              ...
              @foreach ($equipment_requests as $index => $request)
                ...
                >
                  <div class="flex items-center justify-between mb-4">
                    <h3 class="text-sm font-semibold text-txt-black-900">
          ...
          @if ($currentStep == 4)
            ...
            <div class="space-y-6">
              ...
              >
                <h3 class="text-txt-warning font-semibold mb-2">
                  {{ __('forms.terms.title') }}
                </h3>
                <p class="text-sm text-txt-warning mb-4">
                  Saya dengan ini mengesahkan bahawa peralatan yang dipinjam
                  adalah untuk kegunaan rasmi dan akan berada di bawah
                  tanggungjawab saya sepanjang tempoh peminjaman.
                </p>
          ...
          @if ($currentStep == 5)
            ...
            <div class="space-y-6">
              <div
                class="p-4 bg-bg-primary-50 border border-otl-primary-200 rounded-[var(--radius-m)]"
              >
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label
                    class="block text-sm font-medium text-txt-black-900 mb-2 required"
                  >
                    Status Sokongan
                  </label>
                  <div class="space-y-2">
          ...
          @if ($currentStep >= 6)
            <div class="text-center py-8">
              ...
              />
              <h3 class="myds-heading-2xs text-txt-black-900 mb-2">
                {{ __('forms.sections.bpm') ?? 'Bahagian BPM' }}
              </h3>
              ...
              @if ($currentStep == 6)
                <p class="text-sm text-txt-black-500">
                  {{ __('forms.bpm.step_6') ?? 'Proses pengambilan peralatan' }}
                </p>
              @elseif ($currentStep == 7)
                <p class="text-sm text-txt-black-500">
                  {{ __('forms.bpm.step_7') ?? 'Proses pemulangan peralatan' }}
                </p>
              @elseif ($currentStep == 8)
                <p class="text-sm text-txt-black-500">
                  {{ __('forms.bpm.step_8') ?? 'Maklumat terperinci peralatan' }}
                </p>
              @endif
            </div>
          @endif
        ...
        <div class="mt-8 flex flex-col sm:flex-row gap-4">
          ...
          @if ($currentStep < 5)
            <x-myds.button type="button" wire:click="nextStep" class="flex-1">
        ...
        <div
          class="mt-6 p-4 bg-bg-primary-50 border border-otl-primary-200 rounded-[var(--radius-m)]"
        >
          <p class="text-sm text-txt-primary">
        ...
        <div
          class="mt-8 p-6 bg-warning-50 border border-otl-warning-200 rounded-[var(--radius-m)]"
        >
          <h3 class="myds-heading-2xs text-txt-warning mb-4">
            {{ __('forms.terms.title') }}
          </h3>
