...
<x-myds.container>
  ...
  <header class="mb-8">
    ...
    <p class="font-inter text-sm font-normal text-txt-black-500 mt-1">
      ...
      <br class="sm:hidden" />
      <span class="text-txt-black-500/80">
        Please complete the form below to request ICT equipment loan.
      </span>
    </p>
  </header>
  ...
  <form wire:submit="submit" class="space-y-8">
    ...
    <x-myds.card variant="elevated">
      <x-slot name="title">Butiran Permohonan / Request Details</x-slot>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div class="lg:col-span-2">
            <x-myds.textarea
              ...
              :required="true"
              maxlength="500"
              placeholder="{{ __('forms.placeholders.purpose_of_use') }}"
              wire:model.blur="purpose"
              aria-describedby="purpose-help"
            />
            <p id="purpose-help" class="font-inter text-xs text-txt-black-500">
              Berikan penerangan yang jelas untuk memudahkan proses kelulusan.
              <span class="text-txt-black-500/80">
                Provide clear explanation to facilitate approval process.
              </span>
            </p>
          </div>
          ...
          <div>
            ...
            />
            <p id="phone-help" class="font-inter text-xs text-txt-black-500">
              ...
              @foreach ($equipmentCategories as $category)
                ...
                >
                  <div class="flex items-start space-x-3">
                    <svg
                      class="w-5 h-5 text-txt-primary mt-1"
                      aria-hidden="true"
                    >
                    ...
                    <div>
                      <div
                        class="font-inter text-sm font-semibold text-txt-black-900"
                      >
                        {{ $category['name'] }}
                      </div>
        ...
        @if (count($this->selectedEquipmentDetails) > 0)
          <div class="border-t border-otl-gray-200 pt-6">
            <x-myds.heading level="3" spacing="tight">
              ...
              <span
                class="align-middle ml-2 inline-flex items-center rounded-full bg-bg-primary-100 px-2 py-0.5 text-xs font-medium text-txt-primary"
              >
                {{ count($selectedEquipment) }}
              </span>
            </x-myds.heading>
                    ...
                    <div class="flex items-center justify-between">
                      <div class="flex-1">
                        ...
                        @if (! empty($equipment['specifications']))
                          <div
                            class="font-inter text-xs text-txt-black-500 mt-1"
                          >
                      ...
                      <div class="flex items-center space-x-3 ml-4">
                        ...
                        <div class="flex items-center space-x-2">
                          <label
                            for="qty-{{ $equipment['id'] }}"
                            class="font-inter text-xs text-txt-black-700"
                          >
                            Kuantiti:
                          </label>
                          <x-myds.input
        ...
        >
          <div class="font-inter text-sm text-txt-black-700">
            ...
            <span class="text-txt-black-500">
              Request will be sent to supervisor for approval.
            </span>
          </div>
    ...
    <x-myds.modal :open="$showEquipmentModal" maxWidth="3xl">
      <div class="bg-bg-white p-6">
        <div class="flex items-start justify-between mb-4">
          <x-myds.heading level="3" spacing="tight">
            {{ __('forms.placeholders.select_equipment_heading') }}
          </x-myds.heading>
          <x-myds.button
            type="button"
            variant="outline"
            ...
            @foreach ($availableEquipment as $equipment)
              <x-myds.card variant="bordered" padding="small">
                <div class="flex items-start space-x-4">
                  ...
                  <span
                    class="inline-flex items-center rounded-full bg-bg-success-100 px-2 py-0.5 text-xs font-medium text-txt-success"
                  >
        ...
        <div class="mt-6 flex justify-end">
          ...
          >
            ...
            @if (count($selectedEquipment) > 0)
              <span
                class="ml-2 inline-flex items-center rounded-full bg-bg-white px-2 py-0.5 text-xs font-medium text-txt-black-900"
              >
                {{ count($selectedEquipment) }}
              </span>
            @endif
