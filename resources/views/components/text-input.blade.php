...
@props([
  ...
  'minlength' => null,
  'icon' => null,
  //Optional:BladecomponentorSVGforleadingicon'iconRight' => null,
  //Optional:BladecomponentorSVGfortrailingicon'ariaLabel' => null,
...
<div class="relative {{ $class }}">
  @if ($hasIcon)
    <span
      class="absolute left-3 top-1/2 -translate-y-1/2 flex items-center pointer-events-none text-txt-black-500"
    >
      {!! $icon !!}
    </span>
  @endif
  ...
  @if ($hasIconRight)
    <span
      class="absolute right-3 top-1/2 -translate-y-1/2 flex items-center pointer-events-none text-txt-black-500"
    >
      {!! $iconRight !!}
    </span>
  @endif
