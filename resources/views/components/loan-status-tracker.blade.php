...
<div
  class="loan-status-tracker bg-bg-white rounded-lg shadow-card border border-otl-divider p-6"
  @if($polling) wire:poll.{{ $pollInterval }}="refreshStatus" @endif
>
  <!-- Status Header -->
  <div class="flex items-center justify-between mb-6">
    <div>
      <h3 class="text-lg font-semibold text-txt-black-900 font-poppins">
        Request Status
      </h3>
      ...
      <div class="flex items-center space-x-4">
        @foreach ($progressSteps as $index => $step)
          <div class="flex items-center @if(!$loop->last) flex-1 @endif">
            ...
            <div
              class="flex items-center justify-center w-8 h-8 rounded-full border-2 {{ $circleClass }}"
            >
              {!! $inner !!}
            </div>
            <span
              class="ml-2 text-sm font-medium @if ($step["completed"])
                  text-success-700
              @elseif ($index === $currentStep)
                  text-txt-primary
              @else
            ...
            @if (! $loop->last)
              <div
                class="flex-1 h-0.5 mx-4 @if ($index < $currentStep)
                    bg-success-500
                @else
                    bg-otl-divider
                @endif"
  ...
  @if ($showTimeline)
    ...
    <div class="space-y-4">
      <h4
        class="text-sm font-semibold text-txt-black-900 uppercase tracking-wide font-poppins"
      >
        Activity Timeline
      </h4>
      <div class="flow-root">
          ...
          <li class="relative pb-8">
            ...
            <div class="relative flex space-x-3">
              ...
              <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                ...
                <div
                  class="text-right text-sm whitespace-nowrap text-txt-black-500"
                >
                  {{ $loanRequest->created_at->format("M j, Y") }}
                  <br />
                  <span class="text-xs">
                    {{ $loanRequest->created_at->format("g:i A") }}
                  </span>
                </div>
              </div>
            </div>
                ...
                >
                  <div>
                    <p class="text-sm text-txt-black-900">
                      ...
                      <span class="font-medium">
                        {{ $loanRequest->supervisor->name ?? "N/A" }}
                      </span>
                    </p>
                  ...
                  >
                    ...
                    <br />
                    <span class="text-xs">
                      {{ $loanRequest->supervisor_approved_at->format("g:i A") }}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <li class="relative pb-8">
              ...
              <div class="relative flex space-x-3">
                ...
                >
                  <div>
                    <p class="text-sm text-txt-black-900">
                      Approved by ICT admin
                      <span class="font-medium">
                        {{ $loanRequest->ictAdmin->name ?? "N/A" }}
                      </span>
                    </p>
                  ...
                  >
                    ...
                    <br />
                    <span class="text-xs">
                      {{ $loanRequest->ict_approved_at->format("g:i A") }}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="relative flex space-x-3">
                ...
                >
                  ...
                  >
                    ...
                    <br />
                    <span class="text-xs">
                      {{ $loanRequest->issued_at->format("g:i A") }}
                    </span>
                  </div>
                </div>
              </div>
                ...
                >
                  <div>
                    ...
                    @if ($loanRequest->return_condition_notes)
                      <p class="text-xs text-txt-black-500">
                        {{ $loanRequest->return_condition_notes }}
                      </p>
                    @endif
                  </div>
                  <div
                  ...
                  >
                    ...
                    <br />
                    <span class="text-xs">
                      {{ $loanRequest->returned_at->format("g:i A") }}
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="relative flex space-x-3">
                ...
                >
                  ...
                  >
                    ...
                    <br />
                    <span class="text-xs">
                      {{ $loanRequest->updated_at->format("g:i A") }}
                    </span>
                  </div>
                </div>
              </div>
  ...
  @if (! empty($nextActions))
    <div class="mt-6 pt-6 border-t border-otl-divider">
      <h4 class="text-sm font-semibold text-txt-black-900 mb-3 font-poppins">
        Next Steps
      </h4>
      <div class="space-y-2">
