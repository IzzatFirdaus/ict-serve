...
@if ($show)
  ...
  >
    ...
    >
      {{-- Modal Header --}}
      <div
        class="flex items-center justify-between px-6 py-4 border-b border-otl-divider sticky top-0 bg-bg-white z-10 rounded-t-lg"
      >
        @if ($title)
          <h2
            class="text-xl font-semibold text-txt-black-900 font-poppins"
      ...
      @isset($footer)
        <div
          class="px-6 py-4 border-t border-otl-divider bg-bg-white rounded-b-lg"
        >
          {{ $footer }}
        </div>
      @endisset
