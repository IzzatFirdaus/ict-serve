...
<div class="relative" x-data="{ open: false }" @click.outside="open = false" @keydown.escape.window="open = false">
    {{-- Trigger --}}
    <div @click="open = !open" @keydown.enter.prevent="open = !open" tabindex="0" aria-haspopup="menu" aria-expanded="open">
        {{ $trigger }}
    </div>
    ...
    >
        <div class="rounded-md border border-otl-divider bg-white py-1 px-0 focus:outline-none {{ $contentClasses }}">
            {{ $content }}
        </div>
    </div>
</div>
