...
@props([
  ...
  'active' => false,
  'icon' => null,
  //Optional:BladecomponentorSVGforleadingicon'ariaLabel' => null,
  //OptionalARIAlabelforaccessibility,
])

@php
  $baseClasses =
    'flex items-center gap-2 w-full px-4 py-3 rounded-md text-base font-medium transition-colors duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-fr-primary';
  $activeClasses = 'bg-primary-50 text-txt-primary';
  $inactiveClasses =
    'text-txt-black-900 hover:text-txt-primary hover:bg-bg-gray-50';
@endphp
