...
<div
  class="bg-bg-white rounded-lg shadow-card border border-otl-divider p-6 {{ $class }}"
>
  <label
    class="block text-sm font-medium text-txt-black-900 font-poppins mb-2"
    for="{{ $uid }}"
  >
    {{ $label }}
    @if ($required)
      <span class="text-txt-danger ml-1" aria-label="required" title="Required">
        *
      </span>
    @endif
  </label>
  ...
  >
    ...
    @if (! $readonly)
      ...
      >
        ...
        >
          <path
            d="M4.5 10a5.5 5.5 0 0 1 9-4.2M15.5 10a5.5 5.5 0 0 1-9 4.2"
            stroke="currentColor"
            stroke-width="1.5"
            fill="none"
          />
          <path
            d="M13.5 5.5v2h2M6.5 14.5v-2h-2"
            stroke="currentColor"
            stroke-width="1.5"
    ...
    @if ($readonly && $value)
      ...
      <div class="absolute top-3 left-3 flex items-center text-txt-primary">
        ...
        >
          <path
            d="M14.8 4.8a2 2 0 1 1 2.8 2.8L8 17.5 4 18.5l1-4L14.8 4.8z"
            stroke="currentColor"
            stroke-width="1.5"
            fill="none"
          />
