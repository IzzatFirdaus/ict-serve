...
@php
    $baseClasses = 'block w-full px-4 py-2 text-start text-sm font-medium leading-tight rounded-md transition-colors duration-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-fr-primary';
    $stateClasses = $active
