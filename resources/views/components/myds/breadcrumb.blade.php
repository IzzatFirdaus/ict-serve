        ...
        @foreach($items as $index => $item)
            <li>
                <div class="flex items-center">
                    <!-- Separator -->
                    <svg class="w-4 h-4 text-secondary-500 mx-1" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 20 20" aria-hidden="true">
                    ...
                    @if($loop->last)
                        ...
                        <span class="ml-1 text-sm font-inter font-medium text-secondary-500" aria-current="page">
                            {{ $item['label'] }}
                        </span>
                    @else
                        <!-- Linked Item -->
