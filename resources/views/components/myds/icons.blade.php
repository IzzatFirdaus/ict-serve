...
@props([
    ...
    'class' => '', // extra classes for sizing, colour
])
...
@switch(trim($slot))
    @case('search')
        {{-- Search Icon --}}
        <svg xmlns="http://www.w3.org/2000/svg" width="{{ $size }}" height="{{ $size }}" fill="none" viewBox="0 0 20 20" stroke="currentColor" stroke-width="1.5" class="myds-icon {{ $class }}" aria-hidden="true">
    ...
    @case('facebook')
        {{-- Facebook --}}
        <svg xmlns="http://www.w3.org/2000/svg" width="{{ $size }}" height="{{ $size }}" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" class="myds-icon {{ $class }}" aria-hidden="true">
            <rect x="2" y="2" width="16" height="16" rx="4" fill="currentColor" opacity="0.05"/>
            <path d="M13.5 10.6h-2.3V16h-2.1v-5.4H7V8.7h2.1v-1c0-1.3.6-3 2.9-3 .6 0 1.3.1 1.3.1v1.8H13c-.7 0-.8.3-.8.7v1h2l-.2 1.9z" fill="currentColor"/>
        </svg>
        @break
    @case('twitter')
        {{-- Twitter/X --}}
        <svg xmlns="http://www.w3.org/2000/svg" width="{{ $size }}" height="{{ $size }}" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" class="myds-icon {{ $class }}" aria-hidden="true">
            <rect x="2" y="2" width="16" height="16" rx="4" fill="currentColor" opacity="0.05"/>
            <path d="M14.2 7.2L11.4 10l2.9 2.8h-1.7L10.5 10.9 9 12.8H7.5l2.8-2.8-2.7-2.8h1.7l1.3 1.3 1.4-1.3h1.2z" fill="currentColor"/>
        </svg>
        @break
    @case('instagram')
        {{-- Instagram --}}
