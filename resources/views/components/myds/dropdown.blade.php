...
>
  ...
  <div
    ...
    class="absolute {{ $align === 'start' ? 'left-0' : ($align === 'center' ? 'left-1/2 -translate-x-1/2' : 'right-0') }} z-10 mt-2 w-56 origin-top-{{ $align }} divide-y divide-otl-divider radius-l bg-white shadow-context-menu border border-otl-divider myds-dropdown-menu"
    id="dropdown-menu"
    role="menu"
    aria-label="{{ __('ui.dropdown.menu') }}"
    tabindex="-1"
  >
