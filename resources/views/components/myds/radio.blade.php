...
@php
  ...
  $stateClasses = $disabled ? "border-otl-gray-200 bg-black-100 txt-black-500 cursor-not-allowed" : ($error ? "border-otl-danger-300 txt-danger" : "border-otl-gray-200 txt-primary hover:border-otl-gray-200");
...
<div
  {{ $attributes->except(["name", "value", "checked", "required", "disabled", "id"]) }}
>
  ...
  @if ($error)
    <p
      id="{{ $inputId }}-error"
      class="mt-2 text-sm text-txt-danger"
      role="alert"
    >
      {{ $error }}
    </p>
