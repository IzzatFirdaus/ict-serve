            ...
            <div class="flex items-center space-x-2 sm:space-x-4">
                ...
                @if($showNotifications && $user)
                    <div class="relative">
                        ...
                        >
                            <svg class="h-6 w-6" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M10 3a6 6 0 00-6 6v2.159c0 .538-.214 1.055-.595 1.436L2.5 14h15l-.905-1.405A2.032 2.032 0 0116 11.159V9a6 6 0 00-6-6zM8 17a2 2 0 104 0" />
                            </svg>
                            @if($notificationCount > 0)
                                <span class="absolute top-0 right-0 inline-flex items-center justify-center px-2 py-1 text-xs font-bold leading-none text-txt-white transform translate-x-1/2 -translate-y-1/2 bg-danger-600 rounded-full">
                        ...
                        >
                                        ...
                                        <div class="flex">
                                            <div class="flex-shrink-0">
                                                <div class="h-8 w-8 bg-primary-100 rounded-full flex items-center justify-center">
                                                    <svg class="h-4 w-4 text-txt-primary" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                            ...
                            <div class="p-4 border-t border-otl-divider">
                                <a href="{{ route('notifications.index') }}" class="text-sm text-txt-primary hover:text-primary-700 font-medium focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fr-primary rounded">
                        ...
                        >
                            ...
                            <div class="py-1">
                                <a
                                    ...
                                    role="menuitem"
                                >
                                    <svg class="mr-3 h-5 w-5 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                                ...
                                >
                                    <svg class="mr-3 h-5 w-5 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M8 4h4l1 3-3 8-3-8z" />
                                    </svg>
                                    Tetapan
                                </a>
                                ...
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    >
                                        <svg class="mr-3 h-5 w-5 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M11 16l4-4m0 0l-4-4m4 4H7m3 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                                        </svg>
                                        Log Keluar
                                    </button>
                                </form>
