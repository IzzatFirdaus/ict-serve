@props([
  'type' => 'info',
  {{-- JavaScript moved to resources/js/components/toast.js and exposed via resources/js/app.js (@vite) --}}
          ...
          @case('success')
            ...
            >
              <path
                ...
                d="M16 7l-6 6-3-3M10 18a8 8 0 110-16 8 8 0 010 16z"
              />
            </svg>
          ...
          @case('warning')
            ...
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M10 3l8 14H2L10 3zM10 8v4m0 3h.01"
              />
            </svg>
            ...
            <div class="flex items-start">
              <div class="flex-shrink-0">
                <template x-if="toast.type === 'success'">
                  <svg
                    class="h-5 w-5 text-txt-success"
                    viewBox="0 0 20 20"
                    fill="none"
                    stroke="currentColor"
                    stroke-width="1.5"
                ...
                <template x-if="toast.type === 'warning'">
                  <svg
                    class="h-5 w-5 text-txt-warning"
                    viewBox="0 0 20 20"
                    fill="none"
                    stroke="currentColor"
                    stroke-width="1.5"
                ...
                <template x-if="toast.type === 'info'">
                  <svg
                    class="h-5 w-5 text-txt-primary"
                    viewBox="0 0 20 20"
                    fill="none"
                    stroke="currentColor"
                    stroke-width="1.5"
              ...
              <div class="ml-3 w-0 flex-1">
                ...
                <p
                  ...
                  class="text-sm text-txt-black-600"
