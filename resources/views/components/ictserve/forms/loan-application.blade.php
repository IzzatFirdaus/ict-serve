    ...
    >
        ...
        <div class="px-6 py-4 bg-washed rounded-t-lg">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    <h2 id="loan-application-title" class="font-poppins text-2xl md:text-3xl font-semibold text-txt-black-900 dark:text-txt-black-900 leading-tight">
        ...
        <section class="px-6 py-6 grid gap-6">
            ...
            <div class="space-y-6">
                {{-- Kategori Peralatan --}}
                <div>
                    <x-myds.label for="equipment_category" required>Kategori Peralatan</x-myds.label>
                    <x-myds.select
                ...
                {{-- Jenis Peralatan --}}
                <div>
                    <x-myds.label for="equipment_type" required>Jenis Peralatan</x-myds.label>
                    <x-myds.input
                        type="text"
                        id="equipment_type"
                        name="equipment_type"
                ...
                {{-- Spesifikasi Khusus --}}
                <div>
                    <x-myds.label for="specifications">Spesifikasi Khusus (Jika ada)</x-myds.label>
                    <x-myds.textarea
                        id="specifications"
                        name="specifications"
                        :readonly="$readonly"
        ...
        <section class="px-6 py-6 grid gap-6">
            ...
            <div class="space-y-6">
                ...
                {{-- Lokasi Penggunaan --}}
                <div>
                    <x-myds.label for="usage_location" required>Lokasi Penggunaan</x-myds.label>
                    <x-myds.input
                        type="text"
                        id="usage_location"
                        name="usage_location"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <x-myds.label for="loan_end_date" required>Tarikh Akhir Pinjaman</x-myds.label>
                        <x-myds.input
                            type="date"
                            id="loan_end_date"
                            name="loan_end_date"
