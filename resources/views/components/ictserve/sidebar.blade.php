...
>
    ...
    <div class="flex items-center justify-between p-4 border-b border-otl-divider">
        {{-- ICTServe Logo --}}
        <div class="flex items-center w-full" :class="{ 'justify-center': collapsed }">
        ...
        <div class="flex items-center space-x-2" :class="{ 'hidden': collapsed }">
            ...
            >
                ...
                <svg class="h-4 w-4" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M6 3h8v5l-3 3v4l-2 2v-6L6 8V3z" />
                </svg>
            </button>
            ...
            >
                ...
                <svg class="h-4 w-4" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 15l-4-5 4-5M11 15l4-5-4-5" />
                </svg>
            </button>
        </div>
    </div>
    ...
    <nav class="flex-1 p-4" aria-label="Menu navigasi">
        <ul class="space-y-2">
            ...
            <li>
                ...
                >
                    <svg class="h-5 w-5 flex-shrink-0" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                        <path d="M3 7v8a2 2 0 002 2h10a2 2 0 002-2V9a2 2 0 00-2-2H5a2 2 0 00-2-2z"/>
                        <path d="M7 5a2 2 0 012-2h2a2 2 0 012 2v1a2 2 0 01-2 2H9a2 2 0 01-2-2V5z"/>
                    </svg>
            ...
            <li>
                ...
                >
                    <svg class="h-5 w-5 flex-shrink-0" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M10 2a8 8 0 100 16 8 8 0 000-16zM10 10v3m0-6h.01" />
                    </svg>
            ...
            @can('admin-access')
                ...
                <li>
                    ...
                    >
                        <svg class="h-5 w-5 flex-shrink-0" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M10 3l2 4 4 .5-3 3 .7 4.5-3.7-2-3.7 2 .7-4.5-3-3 4-.5 2-4z" />
                        </svg>
    ...
    <div class="p-4 border-t border-otl-divider">
        <div class="flex items-center" :class="{ 'justify-center': collapsed }">
            <img
                ...
                :class="{ 'hidden': collapsed }"
            >
            <div class="h-6 w-6 bg-accent-600 rounded flex items-center justify-center" :class="{ 'hidden': !collapsed }" aria-hidden="true">
