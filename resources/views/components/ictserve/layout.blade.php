...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
  <head>
    ...
    <meta
      name="description"
      content="Sistem Pengurusan Perkhidmatan ICT untuk Kementerian Pelancongan, Seni dan Budaya Malaysia"
    />
    <meta
      name="keywords"
      content="ICT, Malaysia, MOTAC, pinjaman peralatan, helpdesk, servicedesk"
    />
    ...
    <link
      rel="icon"
      type="image/svg+xml"
      href="{{ asset('images/ictserve-icon.svg') }}"
    />
    <link
      rel="icon"
      type="image/png"
      href="{{ asset('images/ictserve-icon.png') }}"
    />

    <!-- Apple Touch Icon -->
    <link
      rel="apple-touch-icon"
      href="{{ asset('images/ictserve-apple-touch-icon.png') }}"
    />
    ...
    <meta
      ...
      content="Sistem Pengurusan Perkhidmatan ICT untuk MOTAC"
    />
    <meta
      property="og:image"
      content="{{ asset('images/ictserve-og-image.png') }}"
    />
  ...
  <body class="h-full bg-bg-light font-body">
    ...
    >
      <div
        class="bg-bg-white rounded-lg p-6 flex items-center space-x-4 shadow-lg"
      >
        <svg
                        ...
                        <li>
                          <div>
                            <a
                              ...
                              class="text-txt-black-400 hover:text-txt-black-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fr-primary rounded"
                            ...
                            >
                              ...
                              >
                                <path
                                  d="M10 2l-7 7h2v7h4v-4h2v4h4v-7h2l-7-7z"
                                />
                              </svg>
                        ...
                        @foreach ($breadcrumbs as $breadcrumb)
                          <li>
                            <div class="flex items-center">
                              <svg
                                class="flex-shrink-0 h-5 w-5 text-txt-black-300"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                                aria-hidden="true"
                              >
                              ...
                              @if (isset($breadcrumb['url']) && ! $loop->last)
                                <a
                                  href="{{ $breadcrumb['url'] }}"
                                  class="ml-4 text-sm font-medium text-txt-black-500 hover:text-txt-black-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fr-primary rounded"
                                >
                                  {{ $breadcrumb['title'] }}
                                </a>
                              @else
                                <span
                                  class="ml-4 text-sm font-medium text-txt-black-900"
                                  aria-current="page"
                                >
                                  {{ $breadcrumb['title'] }}
                                </span>
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <h3 class="text-sm font-medium text-txt-black-900 mb-2">
              ...
              {{-- Quick Links --}}
              <div>
                <h3 class="text-sm font-medium text-txt-black-900 mb-4">
                  Pautan Pantas
                </h3>
                <ul class="space-y-2">
                  <li>
                    <a
                      ...
                      class="text-sm text-txt-black-600 hover:text-txt-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-fr-primary rounded"
                    >
                      Pinjaman Baharu
                    </a>
                  </li>
    ...
    {{-- Shared Alpine.js Stores and Components --}}
