...
<body class="h-full bg-bg-light font-body" x-data="{ 
    ...
    >
        <div class="bg-bg-white rounded-lg p-6 flex items-center space-x-4 shadow-lg">
            <svg class="animate-spin h-6 w-6 text-txt-primary" fill="none" viewBox="0 0 24 24">
                                ...
                                @if(!empty($breadcrumbs))
                                    <nav class="flex" aria-label="Breadcrumb">
                                        <ol class="flex items-center space-x-4">
                                            <li>
                                                <div>
                                                    <a href="{{ route('dashboard') }}" class="text-txt-black-400 hover:text-txt-black-500">
                                            ...
                                            @foreach($breadcrumbs as $breadcrumb)
                                                <li>
                                                    <div class="flex items-center">
                                                        <svg class="flex-shrink-0 h-5 w-5 text-txt-black-300" fill="currentColor" viewBox="0 0 20 20">
                                                            <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"/>
                                                        </svg>
                                                        @if(isset($breadcrumb['url']) && !$loop->last)
                                                            <a href="{{ $breadcrumb['url'] }}" class="ml-4 text-sm font-medium text-txt-black-500 hover:text-txt-black-700">
                                                                {{ $breadcrumb['title'] }}
                                                            </a>
                                                        @else
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div>
                            <div class="flex items-center mb-4">
                                <img src="{{ asset('images/motac-logo.svg') }}" alt="MOTAC" class="h-8 w-auto mr-3">
                                <img src="{{ asset('images/bpm-logo.svg') }}" alt="BPM" class="h-8 w-auto">
                            </div>
                        ...
                        <div>
                            ...
                            <ul class="space-y-2">
                                <li><a href="{{ route('loans.create') }}" class="text-sm text-txt-black-600 hover:text-txt-primary">Pinjaman Baharu</a></li>
                                <li><a href="{{ route('helpdesk.create') }}" class="text-sm text-txt-black-600 hover:text-txt-primary">Aduan Baharu</a></li>
                                <li><a href="{{ route('my-requests') }}" class="text-sm text-txt-black-600 hover:text-txt-primary">Permohonan Saya</a></li>
                                <li><a href="{{ route('help') }}" class="text-sm text-txt-black-600 hover:text-txt-primary">Bantuan</a></li>
                            </ul>
                        </div>
