    ...
    @if ($title || $closeable)
      <div class="px-6 py-4 border-b border-otl-divider bg-gray-50">
        <div class="flex items-center justify-between">
          @if ($title)
            <h3
              class="text-lg font-semibold text-txt-black-900 font-heading"
              id="{{ $titleId }}"
            >
              {{ $title }}
            </h3>
      ...
      <div class="bg-bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="sm:flex sm:items-start">
          ...
          >
            ...
            >
              <path
                stroke-linecap="round"
                stroke-linejoin="round"
                d="M10 7v4m0 4h.01M3 16h14a2 2 0 001.732-3L11.732 4a2 2 0 00-3.464 0L1.268 13A2 2 0 003 16z"
              ></path>
            </svg>
          </div>
          <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
            <h3
              id="confirm-title"
              class="text-lg leading-6 font-medium text-txt-black-900 font-heading"
            >
    ...
    >
      <div class="bg-bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="sm:flex sm:items-start">
          ...
          <div
            class="mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full {{ $currentIcon["bg"] }} sm:mx-0 sm:h-10 sm:w-10"
            aria-hidden="true"
          >
            @switch($alertType)
              @case("success")
                <svg
                  class="h-6 w-6 {{ $currentIcon["text"] }}"
                  viewBox="0 0 20 20"
                  fill="none"
                  stroke="currentColor"
                  stroke-width="1.5"
              ...
              @case("warning")
                ...
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    d="M10 3l-8 14h16L10 3zM10 8v4m0 3h.01"
                  ></path>
                </svg>
              ...
              @default
                ...
                >
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    d="M10 2a8 8 0 100 16 8 8 0 000-16zM10 6v4m0 4h.01"
                  ></path>
                </svg>
            @endswitch
          </div>
