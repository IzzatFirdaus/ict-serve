...
>
    ...
    @if($showNotifications)
        ...
        >
            ...
            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round" d="M10 3a6 6 0 00-6 6v2l-1 2h14l-1-2V9a6 6 0 00-6-6zM8 17a2 2 0 104 0"/>
            </svg>
            @if($hasNotifications)
                <span class="absolute -top-1 -right-1 h-5 w-5 bg-danger-600 text-txt-white text-xs rounded-full flex items-center justify-center font-semibold border-2 border-bg-white">
    ...
    >
        ...
        <nav class="py-1" aria-label="Menu Profil">
            <a
                ...
                role="menuitem"
            >
                <svg class="mr-3 h-4 w-4 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
            ...
            >
                <svg class="mr-3 h-4 w-4 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8 8h4m-4 4h4"/>
                </svg>
                Permohonan Saya
            </a>
            ...
            >
                <svg class="mr-3 h-4 w-4 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 12v2m0-8v2"/>
                </svg>
                Tiket Saya
            </a>
            ...
            >
                <svg class="mr-3 h-4 w-4 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10 6a2 2 0 110 4v2"/>
                </svg>
                Pusat Bantuan
            </a>
            ...
            >
                <svg class="mr-3 h-4 w-4 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" d="M8 6h4m-4 4h4"/>
                </svg>
                Dokumentasi
            </a>
            ...
            <form method="POST" action="{{ route('logout') }}" class="m-0">
                ...
                <button
                    ...
                    role="menuitem"
                >
                    <svg class="mr-3 h-4 w-4 text-danger-500" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M13 16l4-4m0 0l-4-4m4 4H7m3 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
                    Log Keluar
                </button>
            </form>
    ...
    @if($showNotifications)
        ...
        >
            ...
            <div class="px-4 py-3 border-b border-otl-divider flex items-center justify-between">
                    ...
                    <div class="px-4 py-3 border-b border-gray-50 hover:bg-gray-50">
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <p class="text-sm text-txt-black-900">Permohonan pinjaman anda telah diluluskan</p>
                ...
                @else
                    <div class="px-4 py-8 text-center">
                        <svg class="mx-auto h-12 w-12 text-txt-black-400" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                            <circle cx="10" cy="10" r="8"/>
                            <path stroke-linecap="round" stroke-linejoin="round" d="M8 10h4M10 8v4"/>
                        </svg>
                        <p class="mt-2 text-sm text-txt-black-600">Tiada notifikasi baharu</p>
                    </div>
                @endif
            </div>
...
<script>
/**
 * User menu Alpine.js state for accessibility, notification handling, and ARIA support.
 */
function userMenu() {
    return {
        open: false,
         ...
         * After marking, close panel and reload notification count.
         */
        markAllAsRead() {
            fetch('/notifications/mark-all-read', {
                ...
                if (response.ok) {
                    ...
                    // Optionally: update badge count or trigger event
