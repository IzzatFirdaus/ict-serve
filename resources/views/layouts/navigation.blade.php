<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition class="absolute z-50 mt-2 w-64 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
                            <div class="py-1">
                                <a href="{{ route('equipment-loan.create') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    📋 Equipment Loan Request
                                </a>
                                <a href="{{ route('damage-complaint.create') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    🔧 Report Damage/Issues
                                </a>
                                <a href="{{ route('public.my-requests') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    📊 My Requests
                                </a>
                ...
                @else
                    <div class="flex items-center gap-2">
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-600 hover:text-gray-900">{{ __('Register') }}</a>
                        @endif
                    </div>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <div class="px-4 py-2">
                <div class="text-sm font-semibold text-gray-600 border-b border-gray-200 pb-1">ServiceDesk ICT</div>
            </div>
