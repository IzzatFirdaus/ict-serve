  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'body-2xs': ['0.625rem', { lineHeight: '0.75rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],   // 10px
        'body-xs': ['0.75rem', { lineHeight: '1.125rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],    // 12px
        'body-sm': ['0.875rem', { lineHeight: '1.25rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],    // 14px
        'body-base': ['1rem', { lineHeight: '1.5rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],       // 16px
        'body-lg': ['1.125rem', { lineHeight: '1.625rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],   // 18px
        'body-xl': ['1.25rem', { lineHeight: '1.75rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],     // 20px
        'body-2xl': ['1.5rem', { lineHeight: '2rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],        // 24px
        'body-3xl': ['1.875rem', { lineHeight: '2.375rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],  // 30px
        'body-4xl': ['2.25rem', { lineHeight: '2.75rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],    // 36px
        'body-5xl': ['3rem', { lineHeight: '3.75rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],       // 48px
        'body-6xl': ['3.75rem', { lineHeight: '4.5rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],     // 60px
        ...
        'rtf-h1': ['1.875rem', { lineHeight: '2.375rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],  // 30px
        'rtf-h2': ['1.5rem', { lineHeight: '2rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],        // 24px
        'rtf-h3': ['1.25rem', { lineHeight: '1.75rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],    // 20px
        'rtf-h4': ['1.125rem', { lineHeight: '1.625rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],  // 18px
        'rtf-h5': ['1rem', { lineHeight: '1.5rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],        // 16px
        'rtf-h6': ['0.875rem', { lineHeight: '1.25rem', listSpacing: '0.375rem', paragraphSpacing: '0.75rem' }],   // 14px
        'rtf-p': ['1rem', { lineHeight: '1.75rem', listSpacing: '0.375rem', paragraphSpacing: '1.75rem' }],        // 16px with larger paragraph spacing
      },
